...
})({"jWRJK":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4e5dac8afe405db7";
module.bundle.HMR_BUNDLE_ID = "ea004a7a278231e2";
"use strict";
...
function handleStack(stack_elem, maxStacksize) {
    ...
    cards.forEach(function(element) {
        ...
        if (i < maxStacksize - 1) {
            ...
            bottomPos = element.offsetTop;
            if (i > maxStacksize - 1) element.style.display = "none";
        }
        i++;
    });
    function nextCard() {
        ...
        var i1 = 0;
        cards.forEach(function(element) {
            element.style.zIndex = cards.length - i1;
...
//# sourceMappingURL=index.278231e2.js.map

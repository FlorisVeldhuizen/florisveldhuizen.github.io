...
/* START OF CHANGES. I'M DOIGN THIS RIGHT HERR CUZ I'M AN IDIOT AND DON'T KNOW HOW TO EXTEND SHIT OR ANYTHING. */


Grid.prototype.getChessNeighbors = function(node, diagonalMovement, piece) {
    //Chess neighbors code
    var nodes = this.nodes;
    var explore;
    var curx = node.x, cury = node.y;
    var possibleMoves = [];
    findMove = function(dx,dy, grid){
...
//START OF CHANGES TO ASTARFINDER

AStarFinder.prototype.findChessPath = function(startX, startY, endX, endY, grid, piece) {
    var openList = new Heap(function(nodeA, nodeB) {
            return nodeA.f - nodeB.f;
        }),
        startNode = grid.getNodeAt(startX, startY),
    ...
    while (!openList.empty()) {
        ...
        // get neigbours of the current node
        neighbors = grid.getChessNeighbors(node, diagonalMovement, piece);
        for (i = 0, l = neighbors.length; i < l; ++i) {
            neighbor = neighbors[i];

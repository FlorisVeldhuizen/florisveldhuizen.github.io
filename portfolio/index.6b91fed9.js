...
})({"kgrVz":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "ac54ee796b91fed9";
...
},{}],"3uymv":[function(require,module,exports) {
...
window.onload = ()=>{
    ...
    _paperDefault.default.setup(canvas);
    let charpos = new _paperDefault.default.Point(0, 0);
    let movevector = new _paperDefault.default.Point(0, 0);
    let speedvector = new _paperDefault.default.Point(0, 0);
    const pathArray = [];
    ...
    const speedqualizervector = ()=>{
        _movevector = new _paperDefault.default.Point(movevector.x, movevector.y);
        ...
        if (speedvector.length > maxspeed) speedvector.length = maxspeed;
    ...
    const pathHandler = (curPath)=>{
        ...
        if (pathArray.length > maxArraylength) pathArray.shift().remove();
    };
    const drawPlayer = ()=>{
        path.add(charpos);
    ...
    const init = ()=>{
        ...
        path = new _paperDefault.default.Path();
        path.add(charpos);
        path.strokeColor = 'black';
    };
    const optimization = ()=>{
        if (path.segments.length % maxArraylength == 0) path.simplify(0.1);
    };
    _paperDefault.default.view.onFrame = (event)=>{
        speedqualizervector();
...
},{"paper":"agkns","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"agkns":[function(require,module,exports) {
/*!
 ...
 */ var paper = (function(self1, undefined) {
    ...
    var Base1 = new function() {
        var hidden = /^(statics|enumerable|beans|preserve)$/, array = [], slice = array.slice, create = Object.create, describe = Object.getOwnPropertyDescriptor, define = Object.defineProperty, forEach = array.forEach || function(iter, bind) {
        ...
        }, set1 = Object.assign || function(dst) {
        ...
        function inject(dest, src, enumerable, beans, preserve) {
            ...
            if (src) {
                for(var name1 in src)if (src.hasOwnProperty(name1) && !hidden.test(name1)) field(name1);
                for(var name1 in beansNames){
                    var part = beansNames[name1], set = dest['set' + part], get = dest['get' + part] || set && dest['is' + part];
                    if (get && (beans === true || get.length === 0)) field(name1, {
                        get: get,
                        set: set
                    });
                }
        ...
        return inject(Base, {
            ...
            statics: {
                ...
                describe: describe,
                clone: function(obj) {
                    return set1(new obj.constructor(), obj);
                },
    ...
    if (typeof module !== 'undefined') module.exports = Base1;
    Base1.inject({
        enumerable: false,
        toString: function() {
            return this._id != null ? (this._class || 'Object') + (this._name ? " '" + this._name + "'" : ' @' + this._id) : '{ ' + Base1.each(this, function(value, key) {
                if (!/^_/.test(key)) {
        ...
        importJSON: function(json) {
            return Base1.importJSON(json, this);
        },
        exportJSON: function(options) {
            return Base1.exportJSON(this, options);
        },
        toJSON: function() {
            return Base1.serialize(this);
        },
        set: function(props, exclude) {
            if (props) Base1.filter(this, props, exclude, this._prioritize);
            return this;
        }
    }, {
        beans: false,
        statics: {
            ...
            extend: function extend() {
                ...
                if (name && !Base1.exports[name]) Base1.exports[name] = res;
                return res;
            },
            equals: function(obj1, obj2) {
                ...
                if (obj1 && obj2 && typeof obj1 === 'object' && typeof obj2 === 'object') {
                    if (Array.isArray(obj1) && Array.isArray(obj2)) {
                        ...
                        while(length--){
                            if (!Base1.equals(obj1[length], obj2[length])) return false;
                        }
                    } else {
                        ...
                        while(length--){
                            var key = keys[length];
                            if (!(obj2.hasOwnProperty(key) && Base1.equals(obj1[key], obj2[key]))) return false;
                        }
                    }
                    return true;
                }
            ...
            read: function(list, start, options, amount) {
                ...
                obj = Base1.create(proto);
                if (readIndex) obj.__read = true;
                obj = obj.initialize.apply(obj, begin > 0 || begin + amount < length ? Base1.slice(list, begin, begin + amount) : list) || obj;
                if (readIndex) {
            ...
            readNamed: function(list, name, start, options, amount) {
                ...
                if (hasValue) {
                    ...
                    if (!filtered) {
                        ...
                        filtered = list.__filtered = Base1.create(source);
            ...
            getSource: function(list) {
                ...
                if (source === undefined) {
                    ...
                    source = list.__source = arg && Base1.isPlainObject(arg) ? arg : null;
                }
                return source;
            },
            ...
            filter: function(dest, source, exclude, prioritize) {
                ...
                if (prioritize) {
                    ...
                    for(var i = 0, key1, l = prioritize.length; i < l; i++)if ((key1 = prioritize[i]) in source) {
                        handleKey(key1);
                        keys[key1] = true;
                    }
                    processed = keys;
            ...
            isPlainValue: function(obj, asString) {
                return Base1.isPlainObject(obj) || Array.isArray(obj) || asString && typeof obj === 'string';
            },
            serialize: function(obj, options, compact, dictionary) {
                options = options || {
                };
                var isRoot = !dictionary, res1;
                if (isRoot) {
                ...
                if (obj && obj._serialize) {
                    res1 = obj._serialize(options, dictionary);
                    var name2 = obj._class;
                    if (name2 && !obj._compactSerialize && (isRoot || !compact) && res1[0] !== name2) res1.unshift(name2);
                } else if (Array.isArray(obj)) {
                    res1 = [];
                    for(var i = 0, l = obj.length; i < l; i++)res1[i] = Base1.serialize(obj[i], options, compact, dictionary);
                } else if (Base1.isPlainObject(obj)) {
                    res1 = {
                    };
                    var keys = Object.keys(obj);
                    for(var i = 0, l = keys.length; i < l; i++){
                        var key = keys[i];
                        res1[key] = Base1.serialize(obj[key], options, compact, dictionary);
                    }
                } else if (typeof obj === 'number') res1 = options.formatter.number(obj, options.precision);
                else res1 = obj;
            ...
            deserialize: function(json, create, _data, _setDictionary, _isRoot) {
                ...
                if (Array.isArray(json)) {
                    ...
                    type = Base1.exports[type];
                    res = [];
                    for(var i = type ? 1 : 0, l = json.length; i < l; i++)res.push(Base1.deserialize(json[i], create, _data, isDictionary, hasDictionary));
                    if (type) {
                        var args = res;
                        if (create) res = create(type, args, isFirst || _isRoot);
                        else res = new type(args);
                    }
                } else if (Base1.isPlainObject(json)) {
                    res = {
                    };
                    if (_setDictionary) _data.dictionary = res;
                    for(var key in json)res[key] = Base1.deserialize(json[key], create, _data);
                }
                return hasDictionary ? res[1] : res;
            },
            exportJSON: function(obj, options) {
                var json = Base1.serialize(obj, options);
                return options && options.asString == false ? json : JSON.stringify(json);
            },
            importJSON: function(json, target) {
                return Base1.deserialize(typeof json === 'string' ? JSON.parse(json) : json, function(ctor, args, isRoot) {
                    var useTarget = isRoot && target && target.constructor === ctor, obj = useTarget ? target : Base1.create(ctor.prototype);
                    if (args.length === 1 && obj instanceof Item && (useTarget || !(obj instanceof Layer))) {
                        var arg = args[0];
                        if (Base1.isPlainObject(arg)) {
                            arg.insert = false;
            ...
            splice: function(list, items, index, remove) {
                ...
                if (append) {
                    ...
                    if (items) Base1.push(args, items);
    ...
    var Emitter = {
        on: function(type, func) {
            if (typeof type !== 'string') Base1.each(type, function(value, key) {
                this.on(key, value);
            }, this);
            else {
        ...
        off: function(type, func) {
            if (typeof type !== 'string') {
                Base1.each(type, function(value, key) {
                    this.off(key, value);
                }, this);
                return;
            }
        ...
        emit: function(type, event) {
            ...
            var args = Base1.slice(arguments, 1), setTarget = event && event.target && !event.currentTarget;
        ...
        statics: {
            inject: function inject(src) {
                ...
                if (events) {
                    ...
                    Base1.each(events, function(entry, key) {
                        var isString = typeof entry === 'string', name = isString ? entry : key, part = Base1.capitalize(name), type = name.substring(2).toLowerCase();
                        types[type] = isString ? {
                        } : entry;
                        name = '_' + name;
    ...
    var PaperScope1 = Base1.extend({
        _class: 'PaperScope',
        initialize: function PaperScope() {
            paper1 = this;
            this.settings = new Base1({
                applyMatrix: true,
                insertItems: true,
                handleSize: 4,
                hitTolerance: 0
        ...
        execute: function(code, options) {
            var exports = paper1.PaperScript.execute(code, this, options);
            View1.updateFocus();
            return exports;
        },
        install: function(scope) {
            ...
            for(var key2 in this)if (!/^_/.test(key2) && this[key2]) scope[key2] = this[key2];
        },
        ...
        remove: function() {
            this.clear();
            delete PaperScope1._scopes[this._id];
        },
    ...
    var PaperScopeItem = Base1.extend(Emitter, {
        ...
        remove: function() {
            ...
            Base1.splice(this._scope[this._list], null, this._index, 1);
    ...
    var CollisionDetection = {
        ...
        findCurveBoundsCollisions: function(curves1, curves2, tolerance, bothAxis) {
            ...
            if (bothAxis) {
                ...
                for(var i1 = 0, l = hor.length; i1 < l; i1++)list[i1] = {
                    hor: hor[i1],
                    ver: ver[i1]
                };
                return list;
        ...
        findBoundsCollisions: function(boundsA, boundsB, tolerance, sweepVertical, onlySweepAxisCollisions) {
            var self = !boundsB || boundsA === boundsB, allBounds = self ? boundsA : boundsA.concat(boundsB), lengthA = boundsA.length, lengthAll = allBounds.length;
            ...
            for(var i = 0; i < lengthAll; i++){
                var curIndex = allIndicesByPri0[i], curBounds = allBounds[curIndex], origIndex = self ? curIndex : curIndex - lengthA, isCurrentA = curIndex < lengthA, isCurrentB = self || !isCurrentA, curCollisions = isCurrentA ? [] : null;
                if (activeIndicesByPri1.length) {
                    ...
                    if (self && onlySweepAxisCollisions) {
                        ...
                        for(var j = 0; j < activeIndicesByPri1.length; j++){
                            var activeIndex = activeIndicesByPri1[j], activeBounds = allBounds[activeIndex], isActiveA = activeIndex < lengthA, isActiveB = self || activeIndex >= lengthA;
                            if (onlySweepAxisCollisions || (isCurrentA && isActiveB || isCurrentB && isActiveA) && curSec1 >= activeBounds[sec0] - tolerance && curSec0 <= activeBounds[sec1] + tolerance) {
                                if (isCurrentA && isActiveB) curCollisions.push(self ? activeIndex : activeIndex - lengthA);
    ...
    var Formatter = Base1.extend({
        initialize: function(precision) {
            this.precision = Base1.pick(precision, 5);
    ...
    var Numerical = new function() {
        ...
        }, EPSILON = 0.000000000001, MACHINE_EPSILON = 0.000000000000000112;
        ...
        function getNormalizationFactor() {
            ...
            return norm && (norm < 0.00000001 || norm > 100000000) ? pow(2, -Math.round(log2(norm))) : 0;
        }
        return {
            EPSILON: EPSILON,
            MACHINE_EPSILON: MACHINE_EPSILON,
            CURVETIME_EPSILON: 0.00000001,
            GEOMETRIC_EPSILON: 0.0000001,
            TRIGONOMETRIC_EPSILON: 0.00000001,
            KAPPA: 4 * (sqrt(2) - 1) / 3,
            isZero: function(val) {
            ...
            solveCubic: function(a, b, c, d, roots, min, max) {
                ...
                if (abs(a) < EPSILON) {
                    ...
                    evaluate(-(b / a) / 3);
                    var t = q / a, r = pow(abs(t), 1 / 3), s = t < 0 ? -1 : 1, td = -qd / a, rd = td > 0 ? 1.324717957244746 * Math.max(r, sqrt(td)) : r, x01 = x - s * rd;
                    if (x01 !== x) {
                        do {
                            evaluate(x01);
                            x01 = qd === 0 ? x : x - q / qd / (1 + MACHINE_EPSILON);
                        }while (s * x01 > s * x)
    ...
    var Point = Base1.extend({
        ...
        getDistance: function() {
            var args = arguments, point = Point.read(args), x = point.x - this.x, y = point.y - this.y, d = x * x + y * y, squared = Base1.read(args);
        ...
        isClose: function() {
            var args = arguments, point = Point.read(args), tolerance = Base1.read(args);
        ...
        statics: {
            ...
            isCollinear: function(x1, y1, x2, y2) {
                return Math.abs(x1 * y2 - y1 * x2) <= Math.sqrt((x1 * x1 + y1 * y1) * (x2 * x2 + y2 * y2)) * 0.00000001;
            },
            isOrthogonal: function(x1, y1, x2, y2) {
                return Math.abs(x1 * x2 + y1 * y2) <= Math.sqrt((x1 * x1 + y1 * y1) * (x2 * x2 + y2 * y2)) * 0.00000001;
            }
        }
    }, Base1.each([
        'round',
    ...
    var Rectangle = Base1.extend({
        ...
        initialize: function Rectangle(arg0, arg1, arg2, arg3) {
            ...
            if (type === 'number') {
                ...
                if (Array.isArray(arg0)) {
                    ...
                    this._set(0, 0, 0, 0);
                    if (Base1.readSupported(args, this)) read = 1;
                }
            }
            if (read === undefined) {
                var frm = Point.readNamed(args, 'from'), next = Base1.peek(args), x = frm.x, y = frm.y, width, height;
                if (next && next.x !== undefined || Base1.hasNamed(args, 'to')) {
        ...
        equals: function(rect) {
            var rt = Base1.isPlainValue(rect) ? Rectangle.read(arguments) : rect;
        ...
        intersects: function() {
            var rect = Rectangle.read(arguments), epsilon = Base1.read(arguments) || 0;
    ...
    var LinkedRectangle = Rectangle.extend({
        ...
        return Base1.each([
            ...
            var part = Base1.capitalize(key), internal = '_' + key;
    ...
    var Matrix1 = Base1.extend({
        ...
        _serialize: function(options, dictionary) {
            return Base1.serialize(this.getValues(), options, true, dictionary);
        },
        _changed: function() {
            var owner = this._owner;
            if (owner) {
        ...
        clone: function() {
            return new Matrix1(this._a, this._b, this._c, this._d, this._tx, this._ty);
        },
        equals: function(mx) {
        ...
        apply: function(recursively, _setApplyMatrix) {
            var owner = this._owner;
            if (owner) {
                owner.transform(null, Base1.pick(recursively, true), _setApplyMatrix);
        ...
        chain: '#appended',
        _shiftless: function() {
            return new Matrix1(this._a, this._b, this._c, this._d, 0, 0);
        },
        ...
        var part = Base1.capitalize(key), prop = '_' + key;
        this['get' + part] = function() {
            return this[prop];
        };
        this['set' + part] = function(value) {
        ...
        statics: {
            intersect: function(p1x, p1y, v1x, v1y, p2x, p2y, v2x, v2y, asVector, isInfinite) {
                ...
                if (!Numerical.isMachineZero(cross)) {
                    var dx = p1x - p2x, dy = p1y - p2y, u1 = (v2x * dy - v2y * dx) / cross, u2 = (v1x * dy - v1y * dx) / cross, epsilon = 0.000000000001, uMin = -epsilon, uMax = 1 + epsilon;
    ...
    var Project = PaperScopeItem.extend({
        ...
        initialize: function Project(element) {
            ...
            this._view = View1.create(this, element || CanvasProvider.getCanvas(1, 1));
        ...
        _serialize: function(options, dictionary) {
            return Base1.serialize(this._children, options, true, dictionary);
        },
        ...
        importJSON: function(json) {
            ...
            return Base1.importJSON(json, layer && layer.isEmpty() && layer);
        },
        ...
        draw: function(ctx, matrix, pixelRatio) {
            ...
            var children = this._children, param = new Base1({
    ...
    var Item = Base1.extend(Emitter, {
        statics: {
            extend: function extend(src) {
                if (src._serializeFields) src._serializeFields = Base1.set({
        ...
        return Base1.each(handlers, function(name) {
            this._events[name] = {
        ...
        _initialize: function(props, point) {
            var hasProps = props && Base1.isPlainObject(props), internal = hasProps && props.internal === true, matrix = this._matrix = new Matrix1(), project = hasProps && props.project || paper1.project, settings = paper1.settings;
            ...
            if (hasProps && props !== Item.NO_INSERT) this.set(props, {
                internal: true,
                insert: true,
                project: true,
                parent: true
        ...
        _serialize: function(options, dictionary) {
            ...
            function serialize(fields) {
                for(var key in fields){
                    var value = that[key];
                    if (!Base1.equals(value, key === 'leading' ? fields.fontSize * 1.2 : fields[key])) props[key] = Base1.serialize(value, options, key !== 'data', dictionary);
                }
            }
        ...
        var part = Base1.capitalize(name), key = '_' + name, flags = {
            locked: 256,
            visible: 265
        };
        this['get' + part] = function() {
        ...
        getBounds: function(matrix, options) {
            var hasMatrix = options || matrix instanceof Matrix1, opts = Base1.set({
            }, hasMatrix ? options : matrix, this._boundsOptions);
        ...
        setBounds: function() {
            var rect = Rectangle.read(arguments), bounds = this.getBounds(), _matrix = this._matrix, matrix = new Matrix1(), center = rect.getCenter();
            matrix.translate(center);
            if (rect.width != bounds.width || rect.height != bounds.height) {
                if (!_matrix.isInvertible()) {
                    _matrix.set(_matrix._backup || new Matrix1().translate(_matrix.getTranslation()));
        ...
        setScaling: function() {
            ...
            if (current && scaling && !current.equals(scaling)) {
                var rotation = this.getRotation(), decomposed = this._decomposed, matrix = new Matrix1(), isZero = Numerical.isZero;
        ...
        _equals: function(item) {
            return Base1.equals(this._children, item._children);
        },
        clone: function(options) {
            var copy = new this.constructor(Item.NO_INSERT), children = this._children, insert = Base1.pick(options ? options.insert : undefined, options === undefined || options === true), deep = Base1.pick(options ? options.deep : undefined, true);
        ...
        copyAttributes: function(source, excludeMatrix) {
            ...
            this._data = data ? Base1.clone(data) : null;
            if (name) this.setName(name);
        },
        rasterize: function(arg0, arg1) {
            var resolution, insert, raster;
            if (Base1.isPlainObject(arg0)) {
            ...
            if (raster) raster.matrix.reset(true);
            else raster = new Raster(Item.NO_INSERT);
            ...
            if (!rasterSize.isZero()) {
                var ctx = raster.getContext(true), matrix = new Matrix1().scale(scale).translate(topLeft.negate());
                ctx.save();
                matrix.applyToContext(ctx);
                this.draw(ctx, new Base1({
                    matrices: [
                        matrix
                    ]
                }));
            ...
            raster.transform(new Matrix1().translate(topLeft.add(boundsSize.divide(2))).scale(1 / scale));
        ...
        _hitTest: function(point, options, parentViewMatrix) {
            ...
            var matrix = this._matrix, viewMatrix = parentViewMatrix ? parentViewMatrix.appended(matrix) : this.getGlobalMatrix().prepend(this.getView()._matrix), tolerance = Math.max(options.tolerance, 0.000000000001), tolerancePadding = options._tolerancePadding = new Size(Path._getStrokePadding(tolerance, matrix._shiftless().invert()));
            ...
            var checkSelf = !(options.guides && !this._guide || options.selected && !this.isSelected() || options.type && options.type !== Base1.hyphenate(this._class) || options.class && !(this instanceof options.class)), match = options.match, that = this, bounds, res;
            function filter(hit) {
            ...
            function checkPoint(type, part) {
                ...
                if (point.subtract(pt).divide(tolerancePadding).length <= 1) return new HitResult(type, that, {
                    name: part ? Base1.hyphenate(part) : type,
                    point: pt
                });
            }
        ...
        matches: function(name, compare) {
            function matchObject(obj1, obj2) {
                for(var i in obj1)if (obj1.hasOwnProperty(i)) {
                    ...
                    if (Base1.isPlainObject(val1) && Base1.isPlainObject(val2)) {
                        if (!matchObject(val1, val2)) return false;
                    } else if (!Base1.equals(val1, val2)) return false;
                }
                return true;
            }
            ...
            if (type === 'object') {
                ...
                var value = /^(empty|editable)$/.test(name) ? this['is' + Base1.capitalize(name)]() : name === 'type' ? Base1.hyphenate(this._class) : this[name];
                if (name === 'class') {
                ...
                if (typeof compare === 'function') return !!compare(value);
                    ...
                    else if (Base1.isPlainObject(compare)) return matchObject(compare, value);
                }
                return Base1.equals(value, compare);
            }
        },
        getItems: function(options) {
        ...
        statics: {
            _getItems: function _getItems(item, options, matrix, param, firstOnly) {
                ...
                matrix = rect && (matrix || new Matrix1());
        ...
        importJSON: function(json) {
            var res = Base1.importJSON(json, this);
        ...
        insertChildren: function(index, items) {
            ...
            if (children && items && items.length > 0) {
                ...
                Base1.splice(children, items, index, 0);
        ...
        _remove: function(notifySelf, notifyParent) {
            ...
            if (owner) {
                ...
                if (index != null) {
                    ...
                    Base1.splice(owner._children, null, index, 1);
                }
        ...
        removeChildren: function(start, end) {
            ...
            start = start || 0;
            end = Base1.pick(end, this._children.length);
            var removed = Base1.splice(this._children, null, start, end - start);
        ...
        _getOrder: function(item1) {
            ...
            var list1 = getList(this), list2 = getList(item1);
        ...
        this[key] = function() {
            var args = arguments, value = (rotate ? Base1 : Point).read(args), center = Point.read(args, 0, {
                readNull: true
            });
            return this.transform(new Matrix1()[key](value, center || this.getPosition(true)));
        };
    }, {
        translate: function() {
            var mx = new Matrix1();
        ...
        _setStyles: function(ctx, param, viewMatrix) {
            ...
            if (style.hasShadow()) {
                var pixelRatio = param.pixelRatio || 1, mx = viewMatrix._shiftless().prepend(new Matrix1().scale(pixelRatio, pixelRatio)), blur = mx.transform(new Point(style.getShadowBlur(), 0)), offset = mx.transform(this.getShadowOffset());
        ...
        this['removeOn' + Base1.capitalize(key)] = function() {
            var hash = {
            };
            hash[key] = true;
        ...
        tween: function(from, to, options) {
            ...
            var easing = options && options.easing, start = options && options.start, duration = options != null && (typeof options === 'number' ? options : options.duration), tween = new Tween1(this, from, to, duration, easing, start);
    ...
    var Group = Item.extend({
        ...
        _getBounds: function _getBounds(matrix, options) {
            ...
            return clipItem ? clipItem._getCachedBounds(clipItem._matrix.prepended(matrix), Base1.set({
            }, options, {
                stroke: false
    ...
    var Shape = Item.extend({
        ...
        _equals: function(item) {
            return this._type === item._type && this._size.equals(item._size) && Base1.equals(this._radius, item._radius);
        },
        copyContent: function(source) {
        ...
        toPath: function(insert) {
            var path = new Path[Base1.capitalize(this._type)]({
                center: new Point(),
                size: this._size,
                radius: this._radius,
                insert: false
            ...
            if (paper1.settings.applyMatrix) path.setApplyMatrix(true);
        ...
        statics: new function() {
            function createShape(type, point, size, radius, args) {
                var item = Base1.create(Shape.prototype);
                item._type = type;
                item._size = size;
                item._radius = radius;
                item._initialize(Base1.getNamed(args), point);
                return item;
            }
            return {
                Circle: function() {
                    var args = arguments, center = Point.readNamed(args, 'center'), radius = Base1.readNamed(args, 'radius');
    ...
    var Raster = Item.extend({
        ...
        getAverageColor: function(object) {
            ...
            ctx.save();
            var matrix = new Matrix1().scale(width / bounds.width, height / bounds.height).translate(-bounds.x, -bounds.y);
            matrix.applyToContext(ctx);
            if (path) path.draw(ctx, new Base1({
                clip: true,
                matrices: [
                    matrix
                ]
            ...
            return total ? Color1.read(channels) : null;
        },
        getPixel: function() {
            var point = Point.read(arguments);
            var data = this.getContext().getImageData(point.x, point.y, 1, 1).data;
            return new Color1('rgb', [
                data[0] / 255,
                data[1] / 255,
                data[2] / 255
            ], data[3] / 255);
        ...
        setPixel: function() {
            var args = arguments, point = Point.read(args), color = Color1.read(args), components = color._convert('rgb'), alpha = color._alpha, ctx = this.getContext(true), imageData = ctx.createImageData(1, 1), data = imageData.data;
    ...
    var SymbolDefinition = Base1.extend({
        _class: 'SymbolDefinition',
        initialize: function SymbolDefinition(item, dontCenter) {
            this._id = UID.get();
            this.project = paper1.project;
            if (item) this.setItem(item, dontCenter);
        },
        _serialize: function(options, dictionary) {
            return dictionary.add(this, function() {
                return Base1.serialize([
                    this._class,
                    this._item
    ...
    var HitResult = Base1.extend({
        ...
        statics: {
            getOptions: function(args) {
                var options = args && Base1.read(args);
                return new Base1({
                    type: null,
                    tolerance: paper1.settings.hitTolerance,
                    fill: !options,
                    stroke: !options,
                    segments: !options,
                    handles: false,
    ...
    var Segment = Base1.extend({
        ...
        _serialize: function(options, dictionary) {
            ...
            return Base1.serialize(obj, options, true, dictionary);
        },
        ...
        smooth: function(options, _first, _last) {
            var opts = options || {
            }, type = opts.type, factor = opts.factor, prev = this.getPrevious(), next = this.getNext(), p0 = (prev || this)._point, p1 = this._point, p2 = (next || this)._point, d1 = p0.getDistance(p1), d2 = p1.getDistance(p2);
    ...
    var Curve = Base1.extend({
        ...
        _serialize: function(options, dictionary) {
            return Base1.serialize(this.hasHandles() ? [
                this.getPoint1(),
                this.getHandle1(),
                this.getHandle2(),
                this.getPoint2()
        ...
        divideAtTime: function(time, _setHandles) {
            var tMin = 0.00000001, tMax = 1 - tMin, res = null;
        ...
        statics: {
            ...
            getMonoCurves: function(v, dir) {
                ...
                if (o0 >= o1 === o1 >= o2 && o1 >= o2 === o2 >= o3 || Curve.isStraight(v)) curves.push(v);
                    ...
                    var a = 3 * (o1 - o2) - o0 + o3, b = 2 * (o0 + o2) - 4 * o1, c = o1 - o0, tMin = 0.00000001, tMax = 1 - tMin, roots = [], n = Numerical.solveQuadratic(a, b, c, roots, tMin, tMax);
                    if (!n) curves.push(v);
                    else {
                        roots.sort();
            ...
            getTimeOf: function(v, point) {
                var p0 = new Point(v[0], v[1]), p3 = new Point(v[6], v[7]), epsilon = 0.000000000001, geomEpsilon = 0.0000001, t = point.isClose(p0, epsilon) ? 0 : point.isClose(p3, epsilon) ? 1 : null;
                if (t === null) {
                    var coords = [
                        point.x,
                        point.y
            ...
            getNearestTime: function(v, point) {
                if (Curve.isStraight(v)) {
                    ...
                    return u < 0.000000000001 ? 0 : u > 0.999999999999 ? 1 : Curve.getTimeOf(v, new Point(x0 + u * vx, y0 + u * vy));
                }
                ...
                var step = 1 / (count * 2);
                while(step > 0.00000001)if (!refine(minT - step) && !refine(minT + step)) step /= 2;
                return minT;
            },
            ...
            _addBounds: function(v0, v1, v2, v3, coord, padding1, min, max, roots) {
                ...
                padding1 /= 2;
                var minPad = min[coord] + padding1, maxPad = max[coord] - padding1;
                if (v0 < minPad || v1 < minPad || v2 < minPad || v3 < minPad || v0 > maxPad || v1 > maxPad || v2 > maxPad || v3 > maxPad) {
                    if (v1 < v0 != v1 < v3 && v2 < v0 != v2 < v3) {
                        add(v0, 0);
                        add(v3, 0);
                    } else {
                        var a = 3 * (v1 - v2) - v0 + v3, b = 2 * (v0 + v2) - 4 * v1, c = v1 - v0, count = Numerical.solveQuadratic(a, b, c, roots), tMin = 0.00000001, tMax = 1 - tMin;
                        add(v3, 0);
                        for(var i = 0; i < count; i++){
                            var t = roots[i], u = 1 - t;
                            if (tMin <= t && t <= tMax) add(u * u * u * v0 + 3 * u * u * t * v1 + 3 * u * t * t * v2 + t * t * t * v3, padding1);
                        }
                    }
                }
            }
        ...
        isStraight: function(p1, h1, h2, p2) {
            if (h1.isZero() && h2.isZero()) return true;
                ...
                if (v.isZero()) return false;
                    ...
                    var l = new Line(p1, p2), epsilon = 0.0000001;
        ...
        isHorizontal: function() {
            return this.isStraight() && Math.abs(this.getTangentAtTime(0.5).y) < 0.00000001;
        },
        isVertical: function() {
            return this.isStraight() && Math.abs(this.getTangentAtTime(0.5).x) < 0.00000001;
        }
    }), {
        beans: false,
        ...
        return Base1.each(methods, function(name) {
        ...
        function evaluate(v, t, type, normalized) {
            ...
            if (type === 0) {
                ...
                var tMin = 0.00000001, tMax = 1 - tMin;
                if (t < tMin) {
                    x = cx;
                    y = cy;
                } else if (t > tMax) {
        ...
        return {
            statics: {
                classify: function(v) {
                    ...
                    if (isZero(d1)) return isZero(d2) ? type1(isZero(d3) ? 'line' : 'quadratic') : type1(serpentine, d3 / (3 * d2));
                    var d = 3 * d2 * d2 - 4 * d1 * d3;
                    if (isZero(d)) return type1('cusp', d2 / (2 * d1));
                    var f1 = d > 0 ? Math.sqrt(d / 3) : Math.sqrt(-d), f2 = 2 * d1;
                    return type1(d > 0 ? serpentine : 'loop', (d2 + f1) / f2, (d2 - f1) / f2);
                },
                ...
                getTimeAt: function(v, offset, start) {
                    ...
                    var abs = Math.abs, epsilon = 0.000000000001, forward = offset > 0, a = forward ? start : 0, b = forward ? 1 : start, ds = getLengthIntegrand(v), rangeLength = Curve.getLength(v, a, b, ds), diff = abs(offset) - rangeLength;
                    ...
                    return Numerical.findRoot(f, ds, start + guess, a, b, 32, 0.000000000001);
                },
                ...
                getPeaks: function(v) {
                    var x0 = v[0], y0 = v[1], x1 = v[2], y1 = v[3], x2 = v[4], y2 = v[5], x3 = v[6], y3 = v[7], ax = -x0 + 3 * x1 - 3 * x2 + x3, bx = 3 * x0 - 6 * x1 + 3 * x2, cx = -3 * x0 + 3 * x1, ay = -y0 + 3 * y1 - 3 * y2 + y3, by = 3 * y0 - 6 * y1 + 3 * y2, cy = -3 * y0 + 3 * y1, tMin = 0.00000001, tMax = 1 - tMin, roots = [];
        ...
        function addLocation(locations, include, c1, t1, c2, t2, overlap) {
            var excludeStart = !overlap && c1.getPrevious() === c2, excludeEnd = !overlap && c1 !== c2 && c1.getNext() === c2, tMin = 0.00000001, tMax = 1 - tMin;
        ...
        function getCurveIntersections(v1, v2, c1, c2, locations, include) {
            var epsilon = 0.000000000001, min = Math.min, max = Math.max;
        ...
        function getIntersections(curves1, curves2, include, matrix1, matrix2, _returnFirst) {
            var epsilon = 0.0000001, self = !curves2;
            if (self) curves2 = curves1;
            var length1 = curves1.length, length2 = curves2.length, values1 = new Array(length1), values2 = self ? values1 : new Array(length2), locations = [];
            ...
            for(var index1 = 0; index1 < length1; index1++){
                ...
                if (self) getSelfIntersection(v1, curve1, locations, include);
        ...
        function getOverlaps(v1, v2) {
            ...
            var abs = Math.abs, getDistance = Line.getDistance, timeEpsilon = 0.00000001, geomEpsilon = 0.0000001, straight1 = Curve.isStraight(v1), straight2 = Curve.isStraight(v2), straightBoth = straight1 && straight2, flip = getSquaredLineLength(v1) < getSquaredLineLength(v2), l1 = flip ? v2 : v1, l2 = flip ? v1 : v2, px = l1[0], py = l1[1], vx = l1[6] - px, vy = l1[7] - py;
            ...
            for(var i = 0; i < 4 && pairs.length < 2; i++){
                var i1 = i & 1, i2 = i1 ^ 1, t1 = i >> 1, t2 = Curve.getTimeOf(v3[i1], new Point(v3[i2][t1 ? 6 : 0], v3[i2][t1 ? 7 : 1]));
                if (t2 != null) {
                    var pair = i1 ? [
                        t1,
                        t2
    ...
    var CurveLocation = Base1.extend({
        ...
        equals: function(loc, _ignoreOther) {
            ...
            if (!res && loc instanceof CurveLocation) {
                ...
                if (p1 === p2) {
                    var abs = Math.abs, epsilon = 0.0000001, diff = abs(this.getOffset() - loc.getOffset()), i1 = !_ignoreOther && this._intersection, i2 = !_ignoreOther && loc._intersection;
        ...
        isCrossing: function() {
            ...
            var t1 = this.getTime(), t2 = inter.getTime(), tMin = 0.00000001, tMax = 1 - tMin, t1Inside = t1 >= tMin && t1 <= tMax, t2Inside = t2 >= tMin && t2 <= tMax;
            ...
            var pt = this.getPoint(), offset1 = Math.min.apply(Math, offsets), v2 = t1Inside ? c2.getTangentAtTime(t1) : c2.getPointAt(offset1).subtract(pt), v1 = t1Inside ? v2.negate() : c1.getPointAt(-offset1).subtract(pt), v4 = t2Inside ? c4.getTangentAtTime(t2) : c4.getPointAt(offset1).subtract(pt), v3 = t2Inside ? v4.negate() : c3.getPointAt(-offset1).subtract(pt), a1 = v1.getAngle(), a2 = v2.getAngle(), a3 = v3.getAngle(), a4 = v4.getAngle();
    ...
    }, Base1.each(Curve._evaluateMethods, function(name) {
        var get = name + 'At';
        this[name] = function() {
            var curve = this.getCurve(), time = this.getTime();
        ...
        function insert(locations, loc, merge) {
            ...
            function search(index, dir) {
                for(var i = index + dir; i >= -1 && i <= length; i += dir){
                    ...
                    if (!loc.getPoint().isClose(loc2.getPoint(), 0.0000001)) break;
                    if (loc.equals(loc2)) return loc2;
                }
                return null;
            }
            while(l <= r){
                var m = l + r >>> 1, loc21 = locations[m], found;
                if (merge && (found = loc.equals(loc21) ? loc21 : search(m, -1) || search(m, 1))) {
                    if (loc._overlap) found._overlap = found._intersection._overlap = true;
                    return found;
                }
                var path1 = loc.getPath(), path2 = loc21.getPath(), diff = path1 !== path2 ? path1._id - path2._id : loc.getIndex() + loc.getTime() - (loc21.getIndex() + loc21.getTime());
                if (diff < 0) r = m - 1;
                else l = m + 1;
            }
    ...
    var PathItem = Item.extend({
        ...
        getIntersections: function(path, include, _matrix, _returnFirst) {
            var self = this === path || !path, matrix1 = this._matrix._orNullIfIdentity(), matrix2 = self ? matrix1 : (_matrix || path._matrix)._orNullIfIdentity();
            return self || this.getBounds(matrix1).intersects(path.getBounds(matrix2), 0.000000000001) ? Curve.getIntersections(this.getCurves(), !self && path.getCurves(), include, matrix1, matrix2, _returnFirst) : [];
        },
    ...
    var Path = PathItem.extend({
        ...
        _equals: function(item) {
            return this._closed === item._closed && Base1.equals(this._segments, item._segments);
        },
        copyContent: function(source) {
        ...
        setSegments: function(segments) {
            ...
            if (length) {
                ...
                this._add(Segment.readList(segments, 0, {
                }, length));
            }
        ...
        _add: function(segs, index) {
            ...
            if (append) Base1.push(segments, segs);
            else {
        ...
        removeSegments: function(start, end, _includeCurves) {
            start = start || 0;
            end = Base1.pick(end, this._segments.length);
        ...
        splitAt: function(location) {
            var loc = this.getLocationAt(location), index = loc && loc.index, time = loc && loc.time, tMin = 0.00000001, tMax = 1 - tMin;
            if (time > tMax) {
                index++;
                time = 0;
            }
        ...
        reduce: function(options) {
            var curves = this.getCurves(), simplify = options && options.simplify, tolerance = simplify ? 0.0000001 : 0;
        ...
        smooth: function(options) {
            var that = this, opts = options || {
            }, type = opts.type || 'asymmetric', segments = this._segments, length = segments.length, closed = this._closed;
        ...
        compare: function compare(path) {
            ...
            var abs = Math.abs, epsilon = 0.00000001, v2 = values2[pos2], start2;
            while(v1 && v2){
                var overlaps = Curve.getOverlaps(v1, v2);
                if (overlaps) {
                    var t1 = overlaps[0][0];
        ...
        _hitTestSelf: function(point1, options, viewMatrix, strokeMatrix) {
            ...
            function isCloseEnough(pt, padding) {
                return point1.subtract(pt).divide(padding).length <= 1;
            }
            ...
            function checkSegmentStroke(segment) {
                ...
                if ((isJoin ? join : cap) === 'round') return isCloseEnough(segment._point, strokePadding);
                    ...
                    if (!area.isEmpty()) {
                        var loc;
                        return area.contains(point1) || (loc = area.getNearestLocation(point1)) && isCloseEnough(loc.getPoint(), tolerancePadding);
                    }
                }
            }
            ...
            if (strokeRadius !== null) {
                ...
                if (loc1) {
                    var time = loc1.getTime();
                    if (time === 0 || time === 1 && numSegments > 1) {
                        if (!checkSegmentStroke(loc1.getSegment())) loc1 = null;
                    } else if (!isCloseEnough(loc1.getPoint(), strokePadding)) loc1 = null;
                }
                if (!loc1 && join === 'miter' && numSegments > 1) for(var i = 0; i < numSegments; i++){
                    var segment1 = segments[i];
                    if (point1.getDistance(segment1._point) <= miterLimit * strokeRadius && checkSegmentStroke(segment1)) {
                        loc1 = segment1.getLocation();
                        break;
                    }
                }
            }
            return !loc1 && hitFill && this._contains(point1) || loc1 && !hitStroke && !hitCurves ? new HitResult('fill', this) : loc1 ? new HitResult(hitStroke ? 'stroke' : 'curve', this, {
                location: loc1,
                point: loc1.getPoint()
            }) : null;
        }
        ...
        return {
            _draw: function(ctx, param, viewMatrix, strokeMatrix) {
                var dontStart = param.dontStart, dontPaint = param.dontFinish || param.clip, style = this.getStyle(), hasFill = style.hasFill(), hasStroke = style.hasStroke(), dashArray = style.getDashArray(), dashLength = !paper1.support.nativeDash && hasStroke && dashArray && dashArray.length;
            ...
            _drawSelected: function(ctx, matrix) {
                ...
                ctx.stroke();
                drawHandles(ctx, this._segments, matrix, paper1.settings.handleSize);
            }
        };
    }, new function() {
        ...
        return {
            ...
            curveTo: function() {
                var args = arguments, through = Point.read(args), to = Point.read(args), t = Base1.pick(Base1.read(args), 0.5), t1 = 1 - t, current = getCurrentSegment(this)._point, handle = through.subtract(current.multiply(t1 * t1)).subtract(to.multiply(t * t)).divide(2 * t * t1);
                if (handle.isNaN()) throw new Error('Cannot put a curve through points with parameter = ' + t);
                this.quadraticCurveTo(handle, to);
            },
            arcTo: function() {
                var args = arguments, abs = Math.abs, sqrt = Math.sqrt, current = getCurrentSegment(this), from = current._point, to = Point.read(args), through, peek = Base1.peek(args), clockwise = Base1.pick(peek, true), center, extent, vector, matrix;
                if (typeof clockwise === 'boolean') var middle = from.add(to).divide(2), through = middle.add(middle.subtract(from).rotate(clockwise ? -90 : 90));
                else if (Base1.remain(args) <= 2) {
                    through = to;
                    to = Point.read(args);
                } else if (!from.equals(to)) {
                    var radius = Size.read(args), isZero = Numerical.isZero;
                    if (isZero(radius.width) || isZero(radius.height)) return this.lineTo(to);
                    var rotation = Base1.read(args), clockwise = !!Base1.read(args), large = !!Base1.read(args), middle = from.add(to).divide(2), pt = from.subtract(middle).rotate(-rotation), x = pt.x, y = pt.y, rx = abs(radius.width), ry = abs(radius.height), rxSq = rx * rx, rySq = ry * ry, xSq = x * x, ySq = y * y;
                    ...
                    if (abs(factor) < 0.000000000001) factor = 0;
                    ...
                    matrix = new Matrix1().translate(center).rotate(rotation).scale(rx, ry);
                ...
                if (extent) {
                    var epsilon = 0.0000001, ext = abs(extent), count = ext >= 360 ? 4 : Math.ceil((ext - epsilon) / 90), inc = extent / count, half = inc * Math.PI / 360, z = 4 / 3 * Math.sin(half) / (1 + Math.cos(half)), segments = [];
                    for(var i = 0; i <= count; i++){
                        var pt = to, out = null;
                        if (i < count) {
            ...
            curveBy: function() {
                var args = arguments, through = Point.read(args), to = Point.read(args), parameter = Base1.read(args), current = getCurrentSegment(this)._point;
            ...
            arcBy: function() {
                var args = arguments, current = getCurrentSegment(this)._point, point = current.add(Point.read(args)), clockwise = Base1.pick(Base1.peek(args), true);
        ...
        statics: {
            getBounds: function(segments, closed, path, matrix, options, strokePadding) {
                ...
                for(var i2 = 1, l = segments.length; i2 < l; i2++)processSegment(segments[i2]);
            ...
            getStrokeBounds: function(segments, closed, path, matrix, options) {
                ...
                var strokeRadius = strokeWidth / 2, join1 = style.getStrokeJoin(), cap1 = style.getStrokeCap(), miterLimit = style.getMiterLimit(), joinBounds = new Rectangle(new Size(strokePadding));
                ...
                if (length > 0) {
                    for(var i = 1; i < length; i++)addJoin(segments[i], join1);
                    if (closed) addJoin(segments[0], join1);
                    else {
                        addCap(segments[0], cap1);
                        addCap(segments[segments.length - 1], cap1);
                    }
                }
                return bounds;
            },
    ...
    Path.inject({
        statics: new function() {
            ...
            function createPath(segments, closed, args) {
                var props = Base1.getNamed(args), path = new Path(props && props.insert == false && Item.NO_INSERT);
                path._add(segments);
                path._closed = closed;
            ...
            return {
                ...
                Oval: '#Ellipse',
                Arc: function() {
                    var args = arguments, from = Point.readNamed(args, 'from'), through = Point.readNamed(args, 'through'), to = Point.readNamed(args, 'to'), props = Base1.getNamed(args), path = new Path(props && props.insert == false && Item.NO_INSERT);
                    path.moveTo(from);
                    path.arcTo(through, to);
                    return path.set(props);
                },
                RegularPolygon: function() {
                    var args = arguments, center = Point.readNamed(args, 'center'), sides = Base1.readNamed(args, 'sides'), radius = Base1.readNamed(args, 'radius'), step = 360 / sides, three = sides % 3 === 0, vector = new Point(0, three ? -radius : radius), offset = three ? -1 : 0.5, segments = new Array(sides);
                    for(var i = 0; i < sides; i++)segments[i] = new Segment(center.add(vector.rotate((i + offset) * step)));
                    return createPath(segments, true, args);
                },
                Star: function() {
                    var args = arguments, center = Point.readNamed(args, 'center'), points = Base1.readNamed(args, 'points') * 2, radius1 = Base1.readNamed(args, 'radius1'), radius2 = Base1.readNamed(args, 'radius2'), step = 360 / points, vector = new Point(0, -1), segments = new Array(points);
    ...
    var CompoundPath = PathItem.extend({
        ...
        insertChildren: function insertChildren(index, items) {
            ...
            for(var i = items.length - 1; i >= 0; i--){
                var item = list[i];
                if (list === items && !(item instanceof Path)) list = Base1.slice(list);
        ...
        getCurves: function() {
            ...
            for(var i = 0, l = children.length; i < l; i++)Base1.push(curves, children[i].getCurves());
            return curves;
        },
        getFirstCurve: function() {
            var first = this.getFirstChild();
        ...
        _hitTestChildren: function _hitTestChildren(point, options, viewMatrix) {
            return _hitTestChildren.base.call(this, point, options.class === Path || options.type === 'path' ? options : Base1.set({
            }, options, {
                fill: false
            }), viewMatrix);
        },
    ...
    PathItem.inject(new function() {
        ...
        function traceBoolean(path1, path2, operation, options) {
            ...
            var crossings = divideLocations(CurveLocation.expand(_path1.getIntersections(_path2, filterIntersection))), paths1 = getPaths(_path1), paths2 = _path2 && getPaths(_path2), segments = [], curves = [], paths3;
            function collectPaths(paths) {
                for(var i = 0, l = paths.length; i < l; i++){
                    var path = paths[i];
                    Base1.push(segments, path._segments);
                    Base1.push(curves, path.getCurves());
            ...
            if (crossings.length) {
                ...
                for(var i3 = 0, l1 = curves.length; i3 < l1; i3++)curvesValues[i3] = curves[i3].getValues();
                ...
                for(var i3 = 0; i3 < curves.length; i3++){
                    var curve = curves[i3], id = curve._path._id, map = curveCollisionsMap[id] = curveCollisionsMap[id] || {
                    };
                    map[curve.getIndex()] = {
                        hor: getCurves(curveCollisions[i3].hor),
                        ver: getCurves(curveCollisions[i3].ver)
                    };
                }
                for(var i3 = 0, l1 = crossings.length; i3 < l1; i3++)propagateWinding(crossings[i3]._segment, _path1, _path2, curveCollisionsMap, operator);
                for(var i3 = 0, l1 = segments.length; i3 < l1; i3++){
                    var segment = segments[i3], inter = segment._intersection;
                ...
                paths3 = tracePaths(segments, operator);
            } else paths3 = reorientPaths(paths2 ? paths1.concat(paths2) : paths1.slice(), function(w) {
                return !!operator[w];
            });
            return createResult(paths3, true, path1, path2, options);
        }
        function splitBoolean(path1, path2, operation) {
            var _path1 = preparePath(path1), _path2 = preparePath(path2), crossings = _path1.getIntersections(_path2, filterIntersection), subtract = operation === 'subtract', divide = operation === 'divide', added = {
            }, paths = [];
            ...
            for(var i = crossings.length - 1; i >= 0; i--){
                var path3 = crossings[i].split();
                if (path3) {
                    if (addPath(path3)) path3.getFirstSegment().setHandleIn(0, 0);
        ...
        function reorientPaths(paths, isInside, clockwise) {
            ...
            if (length) {
                var lookup = Base1.each(paths, function(path, i) {
                    this[path._id] = {
                        container: null,
                ...
                for(var i4 = 0; i4 < length; i4++){
                    var path1 = sorted[i4], entry1 = lookup[path1._id], containerWinding = 0, indices = collisions[i4];
                    if (indices) {
                        var point = null;
                        for(var j = indices.length - 1; j >= 0; j--)if (indices[j] < i4) {
        ...
        function divideLocations(locations, include, clearLater) {
            var results = include && [], tMin = 0.00000001, tMax = 1 - tMin, clearHandles = false, clearCurves = clearLater || [], clearLookup = clearLater && {
            }, renormalizeLocs, prevCurve, prevTime;
            function getId(curve) {
                return curve._path._id + '.' + curve._segment1._index;
            }
            for(var i = (clearLater && clearLater.length) - 1; i >= 0; i--){
                var curve1 = clearLater[i];
                if (curve1._path) clearLookup[getId(curve1)] = true;
            }
            for(var i = locations.length - 1; i >= 0; i--){
                var loc = locations[i], time = loc._time, origTime = time, exclude = include && !include(loc), curve1 = loc._curve, segment;
                if (curve1) {
                    if (curve1 !== prevCurve) {
                        clearHandles = !curve1.hasHandles() || clearLookup && clearLookup[getId(curve1)];
                        renormalizeLocs = [];
                        prevTime = null;
                        prevCurve = curve1;
                ...
                prevTime = origTime;
                if (time < tMin) segment = curve1._segment1;
                else if (time > tMax) segment = curve1._segment2;
                else {
                    var newCurve = curve1.divideAtTime(time, true);
                    if (clearHandles) clearCurves.push(curve1, newCurve);
        ...
        function getWinding(point, curves, dir, closed, dontFlip) {
            ...
            var ia = dir ? 1 : 0, io = ia ^ 1, pv = [
                point.x,
                point.y
            ], pa = pv[ia], po = pv[io], windingEpsilon = 0.000000001, qualityEpsilon = 0.000001, paL = pa - windingEpsilon, paR = pa + windingEpsilon, windingL = 0, windingR = 0, pathWindingL = 0, pathWindingR = 0, onPath = false, onAnyPath = false, quality = 1, roots = [], vPrev, vClose;
            ...
            for(var i6 = 0, l2 = curvesList.length; i6 < l2; i6++){
                var curve = curvesList[i6], path = curve._path, v4 = curve.getValues(), res2;
                if (!i6 || curvesList[i6 - 1]._path !== path) {
                    vPrev = null;
                    if (!path._closed) {
                ...
                if (res2 = handleCurve(v4)) return res2;
                if (i6 + 1 === l2 || curvesList[i6 + 1]._path !== path) {
                    if (vClose && (res2 = handleCurve(vClose))) return res2;
        ...
        function tracePaths(segments1, operator) {
            var paths = [], starts;
            function isValid(seg) {
                var winding;
                return !!(seg && !seg._visited && (!operator || operator[(winding = seg._winding || {
                }).winding] && !(operator.unite && winding.winding === 2 && winding.windingL && winding.windingR)));
            }
            ...
            function getCrossingSegments(segment, collectStarts) {
                var inter1 = segment._intersection, start = inter1, crossings = [];
                ...
                if (inter1) {
                    collect(inter1);
                    while(inter1 && inter1._previous)inter1 = inter1._previous;
                    collect(inter1, start);
                }
                return crossings;
            }
            segments1.sort(function(seg1, seg2) {
            ...
            for(var i7 = 0, l3 = segments1.length; i7 < l3; i7++){
                var seg1 = segments1[i7], valid = isValid(seg1), path4 = null, finished = false, closed = true, branches = [], branch, visited, handleIn;
                if (valid && seg1._path._overlapsOnly) {
                    var path11 = seg1._path, path21 = seg1._intersection._segment._path;
                    if (path11.compare(path21)) {
                        if (path11.getArea()) paths.push(path11.clone(false));
                        visitPath(path11);
                        visitPath(path21);
                        valid = false;
                    }
                ...
                while(valid){
                    var first = !path4, crossings1 = getCrossingSegments(seg1, first), other1 = crossings1.shift(), finished = !first && (isStart(seg1) || isStart(other1)), cross = !finished && other1;
                    if (first) {
                        path4 = new Path(Item.NO_INSERT);
                        branch = null;
                    }
                    if (finished) {
                        if (seg1.isFirst() || seg1.isLast()) closed = seg1._path._closed;
                        seg1._visited = true;
                        break;
                    }
                    if (cross && branch) {
                    ...
                    if (!branch) {
                        if (cross) crossings1.push(seg1);
                        branch = {
                            start: path4._segments.length,
                            crossings: crossings1,
                            visited: visited = [],
                            handleIn: handleIn
                        };
                    }
                    if (cross) seg1 = other1;
                    if (!isValid(seg1)) {
                        path4.removeSegments(branch.start);
                        for(var j = 0, k = visited.length; j < k; j++)visited[j]._visited = false;
                        visited.length = 0;
                        do {
                            seg1 = branch && branch.crossings.shift();
                            if (!seg1 || !seg1._path) {
                                seg1 = null;
                                branch = branches.pop();
                                if (branch) {
                        ...
                        }while (branch && !isValid(seg1))
                        if (!seg1) break;
                    }
                    var next1 = seg1.getNext();
                    path4.add(new Segment(seg1._point, handleIn, next1 && seg1._handleOut));
                    seg1._visited = true;
                    visited.push(seg1);
                    seg1 = next1 || seg1._path.getFirstSegment();
                    handleIn = next1 && next1._handleIn;
                }
                if (finished) {
                    if (closed) {
                        path4.getFirstSegment().setHandleIn(handleIn);
                        path4.setClosed(closed);
                    }
                    if (path4.getArea() !== 0) paths.push(path4);
                }
            }
            return paths;
        }
            ...
            resolveCrossings: function() {
                ...
                if (hasOverlaps) {
                    ...
                    for(var i = overlaps.length - 1; i >= 0; i--){
                        var overlap = overlaps[i], path5 = overlap._path, seg2 = overlap._segment, prev = seg2.getPrevious(), next = seg2.getNext();
                        if (hasOverlap(prev, path5) && hasOverlap(next, path5)) {
                            seg2.remove();
                            prev._handleOut._set(0, 0);
                            next._handleIn._set(0, 0);
                            if (prev !== seg2 && !prev.getCurve().hasLength()) {
                ...
                if (hasCrossings) {
                    ...
                    paths = tracePaths(Base1.each(paths, function(path) {
                        Base1.push(this, path._segments);
                    }, []));
                }
    ...
    var PathFlattener = Base1.extend({
        _class: 'PathFlattener',
        initialize: function(path, flatness, maxRecursion, ignoreStraight, matrix) {
            var curves = [], parts = [], length = 0, minSpan = 1 / (maxRecursion || 32), segments = path._segments, segment11 = segments[0], segment21;
            ...
            for(var i = 1, l = segments.length; i < l; i++){
                segment21 = segments[i];
                addCurve(segment11, segment21);
                segment11 = segment21;
            }
            if (path._closed) addCurve(segment21 || segment11, segments[0]);
            this.curves = curves;
            this.parts = parts;
            this.length = length;
            this.index = 0;
    ...
    var PathFitter = Base1.extend({
        ...
        generateBezier: function(first, last, uPrime, tan1, tan2) {
            var epsilon = 0.000000000001, abs = Math.abs, points = this.points, pt1 = points[first], pt2 = points[last], C = [
                [
                    0,
                    0
                ],
    ...
    var TextItem = Item.extend({
        ...
        initialize: function TextItem(arg) {
            this._content = '';
            this._lines = [];
            var hasProps = arg && Base1.isPlainObject(arg) && arg.x === undefined && arg.y === undefined;
    ...
    var Color1 = Base1.extend(new function() {
        var types = {
            gray: [
                'gray'
            ],
        ...
        return Base1.each(types, function(properties, type) {
            componentParsers[type] = [];
            Base1.each(properties, function(name, index) {
                var part = Base1.capitalize(name), hasOverlap = /^(hue|saturation)$/.test(name), parser = componentParsers[type][index] = type === 'gradient' ? name === 'gradient' ? function(value) {
            ...
            initialize: function Color(arg) {
                ...
                if (!components) {
                    ...
                    if (values) {
                        ...
                        if (values.length > length) values = Base1.slice(values, 0, length);
            ...
            _serialize: function(options, dictionary) {
                ...
                return Base1.serialize(/^(gray|rgb)$/.test(this._type) ? components : [
                    this._type
            ...
            convert: function(type) {
                return new Color1(type, this._convert(type), this._alpha);
            },
            getType: function() {
                return this._type;
            },
            ...
            equals: function(color) {
                var col = Base1.isPlainValue(color, true) ? Color1.read(arguments) : color;
                return col === this || col && this._class === col._class && this._type === col._type && this.getAlpha() === col.getAlpha() && Base1.equals(this._components, col._components) || false;
            },
            toString: function() {
            ...
            statics: {
                ...
                random: function() {
                    ...
                    return new Color1(random(), random(), random());
                },
        ...
        return Base1.each(operators, function(operator, name) {
            this[name] = function(color) {
                color = Color1.read(arguments);
                ...
                return new Color1(type, components2, this._alpha != null ? operator(this._alpha, color.getAlpha()) : null);
            };
        }, {
        });
    });
    var Gradient = Base1.extend({
        _class: 'Gradient',
        initialize: function Gradient(stops, radial) {
            this._id = UID.get();
            if (stops && Base1.isPlainObject(stops)) {
                this.set(stops);
                stops = radial = null;
            }
    ...
    var GradientStop = Base1.extend({
        ...
        _serialize: function(options, dictionary) {
            ...
            return Base1.serialize(offset == null ? [
                color
            ] : [
                color,
                offset
        ...
        setColor: function() {
            Color1._setOwner(this._color, null);
            this._color = Color1._setOwner(Color1.read(arguments, 0), this, 'setColor');
            this._changed();
        },
    ...
    var Style = Base1.extend(new function() {
        var itemDefaults = {
            fillColor: null,
            fillRule: 'nonzero',
            strokeColor: null,
            ...
            leading: null,
            justification: 'left'
        }), textDefaults = Base1.set({
        }, groupDefaults, {
            fillColor: new Color1()
        }), flags = {
            strokeWidth: 193,
            strokeCap: 193,
            strokeJoin: 193,
            ...
            initialize: function Style(style, _owner, _project) {
                ...
                this._owner = _owner;
                this._project = _owner && _owner._project || _project || paper1.project;
                this._defaults = !_owner || _owner instanceof Group ? groupDefaults : _owner instanceof TextItem ? textDefaults : itemDefaults;
                if (style) this.set(style);
            }
        };
        Base1.each(groupDefaults, function(value1, key) {
            var isColor = /Color$/.test(key), isPoint = key === 'shadowOffset', part = Base1.capitalize(key), flag = flags[key], set = 'set' + part, get = 'get' + part;
            fields[set] = function(value) {
                ...
                if ((key === 'selectedColor' || !applyToChildren) && key in this._defaults) {
                    ...
                    if (old !== value) {
                        if (isColor) {
                            if (old) {
                                Color1._setOwner(old, null);
                                old._canvasStyle = null;
                            }
                            if (value && value.constructor === Color1) value = Color1._setOwner(value, owner, applyToChildren && set);
                        }
            ...
            fields[get] = function(_dontMerge) {
                ...
                if (applyToChildren && !_dontMerge) for(var i = 0, l = children.length; i < l; i++){
                    ...
                    else if (!Base1.equals(value, childValue)) return undefined;
                }
                    ...
                    if (value === undefined) {
                        ...
                        var ctor = isColor ? Color1 : isPoint ? Point : null;
                ...
                if (value && isColor) value = Color1._setOwner(value, owner, applyToChildren && set);
                return value;
            };
        ...
        equals: function(style) {
            function compare(style1, style2, secondary) {
                ...
                for(var key in values1){
                    ...
                    if (!(secondary && key in values2) && !Base1.equals(value1, value2 === undefined ? defaults2[key] : value2)) return false;
                }
                return true;
            }
    ...
    var View1 = Base1.extend(Emitter, {
        _class: 'View',
        initialize: function View(project, element) {
            ...
            if (window && element) {
                ...
                if (PaperScope1.hasAttribute(element, 'resize')) {
                    var that = this;
                ...
                size1 = getCanvasSize();
                if (PaperScope1.hasAttribute(element, 'stats') && typeof Stats !== 'undefined') {
            ...
            this._setElementSize(size1.width, size1.height);
            this._viewSize = size1;
            View._views.push(this);
            View._viewsById[this._id] = this;
            (this._matrix = new Matrix1())._owner = this;
            ...
            this._autoUpdate = !paper1.agent.node;
            this._needsUpdate = false;
        },
        remove: function() {
            if (!this._project) return false;
            if (View1._focused === this) View1._focused = null;
            View1._views.splice(View1._views.indexOf(this), 1);
            delete View1._viewsById[this._id];
            var project = this._project;
        ...
        _events: Base1.each(Item._itemHandlers.concat([
            'onResize',
            'onKeyDown',
            'onKeyUp'
        ]), function(name) {
            ...
            if (!this._requested) {
                ...
                DomEvent.requestAnimationFrame(function() {
                    ...
                    if (that._animate) {
                        ...
                        if ((!DomElement.getPrefixed(document, 'hidden') || PaperScope1.getAttribute(element, 'keepalive') === 'true') && DomElement.isInView(element)) that._handleFrame();
                    }
        ...
        _handleFrameItems: function(event) {
            for(var i in this._frameItems){
                ...
                entry.item.emit('frame', new Base1(event, {
        ...
        this[key] = function() {
            ...
            return this.transform(new Matrix1()[key](value, center || this.getCenter(true)));
        };
    }, {
        _decompose: function() {
        ...
        setZoom: function(zoom) {
            this.transform(new Matrix1().scale(zoom / this.getZoom(), this.getCenter()));
        },
        getRotation: function() {
        ...
        statics: {
            ...
            create: function(project, element) {
                ...
                var ctor = window ? CanvasView : View1;
        ...
        function getView(event) {
            ...
            return target.getAttribute && View1._viewsById[target.getAttribute('id')];
        }
        function updateFocus() {
            var view = View1._focused;
            if (!view || !view.isVisible()) {
                for(var i = 0, l = View1._views.length; i < l; i++)if ((view = View1._views[i]).isVisible()) {
                    View1._focused = tempFocus = view;
                    break;
                }
            }
        }
        ...
        var viewEvents = {
            ...
            mouseout: function(event) {
                var view = View1._focused, target = DomEvent.getRelatedTarget(event);
        ...
        viewEvents[mousedown] = function(event) {
            var view = View1._focused = getView(event);
            if (!dragging) {
                dragging = true;
            ...
            if (!mouseDown) {
                ...
                if (target) {
                    if (view !== target) {
                        ...
                        view = View1._focused = tempFocus = target;
                    }
                } else if (tempFocus && tempFocus === view) {
                    if (prevFocus && !prevFocus.isInserted()) prevFocus = null;
                    view = View1._focused = prevFocus;
                    prevFocus = null;
                    updateFocus();
                }
            }
        ...
        function emitMouseEvent(obj1, target, type2, event, point, prevPoint, stopItem) {
            ...
            while(obj1 && obj1 !== stopItem){
                if (emit(obj1, type2)) break;
                obj1 = obj1._parent;
            }
            return stopped;
        }
        ...
        return {
            ...
            _handleMouseEvent: function(type3, event, point) {
                var itemEvents = this._itemEvents, hitItems = itemEvents.native[type3], nativeMove = type3 === 'mousemove', tool = this._scope.tool, view = this;
                function responds(type) {
                    return itemEvents.virtual[type] || view.responds(type) || tool && tool.responds(type);
                }
                if (nativeMove && dragging && responds('mousedrag')) type3 = 'mousedrag';
                ...
                if ((inView || mouse.drag) && !point.equals(lastPoint)) {
                    emitMouseEvents(this, hitItem, nativeMove ? type3 : 'mousemove', event, point, lastPoint);
                    handle = true;
                }
                wasInView = inView;
                if (mouse.down && inView || mouse.up && downPoint) {
                    emitMouseEvents(this, hitItem, type3, event, point, downPoint);
                    if (mouse.down) {
                ...
                lastPoint = point;
                if (handle && tool) called = tool._handleMouseEvent(type3, event, point, mouse) || called;
    ...
    var CanvasView = View1.extend({
        _class: 'CanvasView',
        initialize: function CanvasView(project, canvas) {
            if (!(canvas instanceof window.HTMLCanvasElement)) {
                var size = Size.read(arguments, 1);
                if (size.isZero()) throw new Error('Cannot create CanvasView with the provided argument: ' + Base1.slice(arguments, 1));
                canvas = CanvasProvider.getCanvas(size);
            }
            var ctx = this._context = canvas.getContext('2d');
            ctx.save();
            this._pixelRatio = 1;
            if (!/^off|false$/.test(PaperScope1.getAttribute(canvas, 'hidpi'))) {
                var deviceRatio = window.devicePixelRatio || 1, backingStoreRatio = DomElement.getPrefixed(ctx, 'backingStorePixelRatio') || 1;
                this._pixelRatio = deviceRatio / backingStoreRatio;
            }
            View1.call(this, project, canvas);
    ...
    var Key = new function() {
        ...
        }, metaFixMap, downKey, modifiers = new Base1({
            shift: false,
            control: false,
            alt: false,
            meta: false,
        ...
        function getKey(event) {
            ...
            return keyLookup[key] || (key.length > 1 ? Base1.hyphenate(key) : key.toLowerCase());
        }
        function handleKey(down, key, character, event) {
            var type = down ? 'keydown' : 'keyup', view = View1._focused, name;
            keyMap[key] = down;
            if (down) charMap[key] = character;
            else delete charMap[key];
            if (key.length > 1 && (name = Base1.camelize(key)) in modifiers) {
                modifiers[name] = down;
                var agent = paper1 && paper1.agent;
        ...
        DomEvent.add(document, {
            keydown: function(event) {
                var key = getKey(event), agent = paper1 && paper1.agent;
    ...
    var Tool = PaperScopeItem.extend({
        ...
        _handleMouseEvent: function(type, event, point, mouse) {
            ...
            var move = mouse.move || mouse.drag, responds = this.responds(type), minDistance1 = this.minDistance, maxDistance1 = this.maxDistance, called = false, tool = this;
            ...
            if (mouse.down) {
                ...
                update(null, maxDistance1);
                emit();
            } else if (responds) while(update(minDistance1, maxDistance1))emit();
            return called;
        }
    });
    var Tween1 = Base1.extend(Emitter, {
        _class: 'Tween',
        statics: {
            easings: new Base1({
                linear: function(t) {
        ...
        update: function(progress) {
            if (this.running) {
                ...
                for(var i = 0, l = keys && keys.length; i < l; i++){
                    var key = keys[i], from = getValue(this._from[key]), to = getValue(this._to[key]), value2 = from && to && from.__add && to.__add ? to.__subtract(from).__multiply(factor).__add(from) : (to - from) * factor + from;
                    this._setProperty(this._parsedKeys[key], value2);
                }
                if (this.responds('update')) this.emit('update', new Base1({
                    progress: progress,
                    factor: factor
                }));
        ...
        _calculate: function(left, operator, right) {
            return paper1.PaperScript.calculateBinary(left, operator, right);
        },
    ...
    var Http = {
        request: function(options) {
            ...
            xhr.open((options.method || 'get').toUpperCase(), options.url, Base1.pick(options.async, true));
    ...
    var CanvasProvider = Base1.exports.CanvasProvider = {
        canvases: [],
    ...
    var BlendMode = new function() {
        ...
        var nativeModes = this.nativeModes = Base1.each([
            'source-over',
            'source-in',
            'source-out',
            'source-atop',
        ...
        var ctx = CanvasProvider.getContext(1, 1);
        if (ctx) {
            Base1.each(modes, function(func, mode) {
    ...
    var SvgStyles = Base1.each({
        ...
        var part = Base1.capitalize(key), lookup = entry[2];
        this[key] = {
            type: entry[1],
            property: key,
            attribute: entry[0],
            toSVG: lookup,
            fromSVG: lookup && Base1.each(lookup, function(value, name) {
                this[value] = name;
            }, {
            }),
    ...
    new function() {
        ...
        function getTransform(matrix, coordinates, center) {
            var attrs = new Base1(), trans = matrix.getTranslation();
            if (coordinates) {
                var point;
        ...
        function applyStyle(item, node, isRoot) {
            var attrs = {
            }, parent = !isRoot && item.getParent(), style = [];
            if (item._name != null) attrs.id = item._name;
            Base1.each(SvgStyles, function(entry) {
                var get = entry.get, type = entry.type, value = item[get]();
                if (entry.exportFilter ? entry.exportFilter(item, value) : !parent || !Base1.equals(parent[get](), value)) {
        ...
        Project.inject({
            exportSVG: function(options) {
                options = setOptions(options);
                var children = this._children, view = this.getView(), bounds = Base1.pick(options.bounds, 'view'), mx = options.matrix || bounds === 'view' && view._matrix, matrix = mx && Matrix1.read([
                    mx
    ...
    new function() {
        ...
        function importGradient(node, type) {
            ...
            var color = applyAttributes(new Color1(gradient, origin, destination, highlight), node);
        ...
        var importers = {
            ...
            image: function(node) {
                ...
                raster.on('load', function() {
                    ...
                    this._matrix.append(new Matrix1().translate(center));
                });
                return raster;
            },
        ...
        function applyTransform(item, value, name, node) {
            if (item.transform) {
                var transforms = (node.getAttribute(name) || '').split(/\)\s*/g), matrix = new Matrix1();
                for(var i = 0, l = transforms.length; i < l; i++){
                    ...
                    switch(command){
                        case 'matrix':
                            matrix.append(new Matrix1(v[0], v[1], v[2], v[3], v[4], v[5]));
                            break;
                        case 'rotate':
        ...
        var attributes = Base1.set(Base1.each(SvgStyles, function(entry) {
                    ...
                    if (entry.type === 'color') {
                        ...
                        if (color) {
                            if (color._scaleToBounds) {
                                ...
                                color.transform(new Matrix1().translate(bounds.getPoint()).scale(bounds.getSize()));
                            }
                        }
                    }
                }
            ...
            viewBox: function(item, value, name, node, styles) {
                ...
                if (item instanceof Group) {
                    var scale = size ? size.divide(rect.getSize()) : 1, matrix = new Matrix1().scale(scale).translate(rect.getPoint().negate());
                    group = item;
        ...
        function applyAttributes(item, node, isRoot) {
            ...
            Base1.each(attributes, function(apply, name) {
        ...
        function importNode(node, options, isRoot) {
            ...
            if (isRoot && isElement) {
                rootSize = paper1.getView().getSize();
            ...
            var settings = paper1.settings, applyMatrix = settings.applyMatrix, insertItems = settings.insertItems;
            ...
            if (isRoot) {
                ...
                if (item && Base1.pick(options.applyMatrix, applyMatrix)) item.matrix.apply(true, true);
            }
            return item;
        }
        function importSVG(source, options, owner) {
            ...
            var scope = paper1, item = null;
            function onLoad1(svg) {
                try {
            ...
            function onError1(message, status) {
                var onError = options.onError;
                if (onError) onError(message, status);
                else throw new Error(message);
            }
            if (typeof source === 'string' && !/^[\s\S]*</.test(source)) {
                var node1 = document.getElementById(source);
                if (node1) onLoad1(node1);
                else Http.request({
                    url: source,
                    async: true,
                    onLoad: onLoad1,
    ...
    Base1.exports.PaperScript = (function() {
        var global = this, acorn = global.acorn;
        if (!acorn && typeof require !== 'undefined') try {
            acorn = require('acorn');
        } catch (e1) {
        }
        if (!acorn) {
            var exports1, module;
            acorn = exports1 = module = {
            };
            (function(root, mod) {
                if (typeof exports1 == "object" && typeof module == "object") return mod(exports1);
                ...
                var options, input1, inputLen, sourceFile;
                exports.parse = function(inpt, opts) {
                    input1 = String(inpt);
                    inputLen = input1.length;
                    setOptions(opts);
                    initTokenState();
                ...
                exports.tokenize = function(inpt, opts) {
                    ...
                    getToken.jumpTo = function(pos, reAllowed) {
                        ...
                        if (options.locations) {
                            ...
                            var match;
                            while((match = lineBreak.exec(input1)) && match.index < pos){
                                ++tokCurLine;
                ...
                var inFunction, labels, strict1;
                function raise(pos, message) {
                    var loc = getLineInfo(input1, pos);
                ...
                function makePredicate(words) {
                    words = words.split(" ");
                    var f = "", cats = [];
                    out: for(var i8 = 0; i8 < words.length; ++i8){
                        for(var j = 0; j < cats.length; ++j)if (cats[j][0].length == words[i8].length) {
                            cats[j].push(words[i8]);
                            continue out;
                        }
                        cats.push([
                            words[i8]
                    ...
                    if (cats.length > 3) {
                        ...
                        f += "switch(str.length){";
                        for(var i8 = 0; i8 < cats.length; ++i8){
                            var cat = cats[i8];
                            f += "case " + cat[0].length + ":";
                            compareTo(cat);
                        }
                ...
                function skipBlockComment() {
                    ...
                    var start = tokPos, end = input1.indexOf("*/", tokPos += 2);
                    if (end === -1) raise(tokPos - 2, "Unterminated comment");
                    tokPos = end + 2;
                    if (options.locations) {
                        lineBreak.lastIndex = start;
                        var match;
                        while((match = lineBreak.exec(input1)) && match.index < tokPos){
                            ++tokCurLine;
                            tokLineStart = match.index + match[0].length;
                        }
                    }
                    if (options.onComment) options.onComment(true, input1.slice(start + 2, end), start, tokPos, startLoc, options.locations && new line_loc_t);
                }
                function skipLineComment() {
                    var start = tokPos;
                    var startLoc = options.onComment && options.locations && new line_loc_t;
                    var ch = input1.charCodeAt(tokPos += 2);
                    while(tokPos < inputLen && ch !== 10 && ch !== 13 && ch !== 8232 && ch !== 8233){
                        ++tokPos;
                        ch = input1.charCodeAt(tokPos);
                    }
                    if (options.onComment) options.onComment(false, input1.slice(start + 2, tokPos), start, tokPos, startLoc, options.locations && new line_loc_t);
                }
                function skipSpace() {
                    while(tokPos < inputLen){
                        var ch = input1.charCodeAt(tokPos);
                        if (ch === 32) ++tokPos;
                        else if (ch === 13) {
                            ++tokPos;
                            var next = input1.charCodeAt(tokPos);
                            if (next === 10) ++tokPos;
                            if (options.locations) {
                                ++tokCurLine;
                                tokLineStart = tokPos;
                            ...
                            var next = input1.charCodeAt(tokPos + 1);
                ...
                function readToken_plus_min(code) {
                    var next = input1.charCodeAt(tokPos + 1);
                    if (next === code) {
                        if (next == 45 && input1.charCodeAt(tokPos + 2) == 62 && newline.test(input1.slice(lastEnd, tokPos))) {
                            tokPos += 3;
                            skipLineComment();
                            skipSpace();
                            return readToken();
                ...
                function readToken_lt_gt(code) {
                    ...
                    var size = 1;
                    if (next === code) {
                        size = code === 62 && input1.charCodeAt(tokPos + 2) === 62 ? 3 : 2;
                        if (input1.charCodeAt(tokPos + size) === 61) return finishOp(_assign, size + 1);
                        return finishOp(_bitShift, size);
                    }
                    if (next == 33 && code == 60 && input1.charCodeAt(tokPos + 2) == 45 && input1.charCodeAt(tokPos + 3) == 45) {
                        tokPos += 4;
                        skipLineComment();
                        skipSpace();
                        return readToken();
                    }
                    if (next === 61) size = input1.charCodeAt(tokPos + 2) === 61 ? 3 : 2;
                    return finishOp(_relational, size);
                }
                function readToken_eq_excl(code) {
                    var next = input1.charCodeAt(tokPos + 1);
                    if (next === 61) return finishOp(_equality, input1.charCodeAt(tokPos + 2) === 61 ? 3 : 2);
                ...
                function readToken(forceRegexp) {
                    ...
                    var code = input1.charCodeAt(tokPos);
                ...
                function finishOp(type, size) {
                    var str = input1.slice(tokPos, tokPos + size);
                    tokPos += size;
                ...
                function readRegexp() {
                    ...
                    var content = input1.slice(start, tokPos);
                    ++tokPos;
                    var mods = readWord1();
                ...
                function readInt(radix, len) {
                    ...
                    for(var i = 0, e = len == null ? Infinity : len; i < e; ++i){
                        var code = input1.charCodeAt(tokPos), val;
                ...
                function readHexNumber() {
                    ...
                    if (isIdentifierStart(input1.charCodeAt(tokPos))) raise(tokPos, "Identifier directly after number");
                    return finishToken(_num, val);
                }
                function readNumber(startsWithDot) {
                    var start = tokPos, isFloat = false, octal = input1.charCodeAt(tokPos) === 48;
                    if (!startsWithDot && readInt(10) === null) raise(start, "Invalid number");
                    if (input1.charCodeAt(tokPos) === 46) {
                        ++tokPos;
                        readInt(10);
                        isFloat = true;
                    }
                    var next = input1.charCodeAt(tokPos);
                    if (next === 69 || next === 101) {
                        next = input1.charCodeAt(++tokPos);
                        if (next === 43 || next === 45) ++tokPos;
                        if (readInt(10) === null) raise(start, "Invalid number");
                        isFloat = true;
                    }
                    if (isIdentifierStart(input1.charCodeAt(tokPos))) raise(tokPos, "Identifier directly after number");
                    var str = input1.slice(start, tokPos), val;
                    if (isFloat) val = parseFloat(str);
                    else if (!octal || str.length === 1) val = parseInt(str, 10);
                    else if (/[89]/.test(str) || strict1) raise(start, "Invalid number");
                ...
                function readString(quote) {
                    ...
                    for(;;){
                        ...
                        if (ch === 92) {
                            ch = input1.charCodeAt(++tokPos);
                            var octal = /^[0-7]+/.exec(input1.slice(tokPos, tokPos + 3));
                            if (octal) octal = octal[0];
                            while(octal && parseInt(octal, 8) > 255)octal = octal.slice(0, -1);
                            if (octal === "0") octal = null;
                            ++tokPos;
                            if (octal) {
                                if (strict1) raise(tokPos - 2, "Octal literal in strict mode");
                                ...
                                case 48:
                                    ...
                                    break;
                                case 13:
                                    if (input1.charCodeAt(tokPos) === 10) ++tokPos;
                                case 10:
                                    if (options.locations) {
                                        tokLineStart = tokPos;
                                        ++tokCurLine;
                ...
                function readWord1() {
                    ...
                    for(;;){
                        ...
                        if (isIdentifierChar(ch)) {
                            if (containsEsc) word += input1.charAt(tokPos);
                            ++tokPos;
                        } else if (ch === 92) {
                            if (!containsEsc) word = input1.slice(start, tokPos);
                            containsEsc = true;
                            if (input1.charCodeAt(++tokPos) != 117) raise(tokPos, "Expecting Unicode escape sequence \\uXXXX");
                            ++tokPos;
                    ...
                    return containsEsc ? word : input1.slice(start, tokPos);
                }
                function readWord() {
                    var word = readWord1();
                    var type = _name;
                ...
                function setStrict(strct) {
                    ...
                    if (options.locations) while(tokPos < tokLineStart){
                        tokLineStart = input1.lastIndexOf("\n", tokLineStart - 2) + 1;
                        --tokCurLine;
                    }
                    skipSpace();
                    readToken();
                ...
                function canInsertSemicolon() {
                    return !options.strictSemicolons && (tokType === _eof || tokType === _braceR || newline.test(input1.slice(lastEnd, tokStart)));
                }
                function semicolon() {
                    if (!eat(_semi) && !canInsertSemicolon()) unexpected();
                }
                function expect(type) {
                    if (tokType === type) next2();
                    else unexpected();
                }
                function unexpected() {
                ...
                function checkLVal(expr) {
                    ...
                    if (strict1 && expr.type === "Identifier" && isStrictBadIdWord(expr.name)) raise(expr.start, "Assigning to " + expr.name + " in strict mode");
                }
                function parseTopLevel(program) {
                    lastStart = lastEnd = tokPos;
                    if (options.locations) lastEndLoc = new line_loc_t;
                    inFunction = strict1 = null;
                    labels = [];
                    readToken();
                ...
                function parseStatement() {
                    ...
                    switch(starttype){
                        ...
                        case _throw:
                            next2();
                            if (newline.test(input1.slice(lastEnd, tokStart))) raise(lastEnd, "Illegal newline after throw");
                            node.argument = parseExpression();
                            semicolon();
                        ...
                        case _try:
                            ...
                            if (tokType === _catch) {
                                ...
                                if (strict1 && isStrictBadIdWord(clause.param.name)) raise(clause.param.start, "Binding " + clause.param.name + " in strict mode");
                                expect(_parenR);
                                clause.guard = null;
                        ...
                        case _with:
                            if (strict1) raise(tokStart, "'with' in strict mode");
                            next2();
                ...
                function parseVar(node, noIn) {
                    ...
                    for(;;){
                        var decl = startNode();
                        decl.id = parseIdent();
                        if (strict1 && isStrictBadIdWord(decl.id.name)) raise(decl.id.start, "Binding " + decl.id.name + " in strict mode");
                ...
                function parseMaybeUnary() {
                    if (tokType.prefix) {
                        ...
                        else if (strict1 && node.operator === "delete" && node.argument.type === "Identifier") raise(node.start, "Deleting local variable in strict mode");
                ...
                function parseExprAtom() {
                    switch(tokType){
                        ...
                        case _regexp:
                            var node = startNode();
                            node.value = tokVal;
                            node.raw = input1.slice(tokStart, tokEnd);
                            next2();
                ...
                function parseObj() {
                    ...
                    while(!eat(_braceR)){
                        ...
                        if (prop.key.type === "Identifier" && (strict1 || sawGetSet)) for(var i = 0; i < node.properties.length; ++i){
                            var other = node.properties[i];
                            if (other.key.name === prop.key.name) {
                                var conflict = kind == other.kind || isGetSet && other.kind === "init" || kind === "init" && (other.kind === "get" || other.kind === "set");
                                if (conflict && !strict1 && kind === "init" && other.kind === "init") conflict = false;
                ...
                function parseFunction(node, isStatement) {
                    ...
                    labels = oldLabels;
                    if (strict1 || node.body.body.length && isUseStrict(node.body.body[0])) for(var i = node.id ? -1 : 0; i < node.params.length; ++i){
                ...
                function parseIdent(liberal) {
                    ...
                    if (tokType === _name) {
                        if (!liberal && (options.forbidReserved && (options.ecmaVersion === 3 ? isReservedWord3 : isReservedWord5)(tokVal) || strict1 && isStrictReservedWord(tokVal)) && input1.slice(tokStart, tokEnd).indexOf("\\") == -1) raise(tokStart, "The keyword '" + tokVal + "' is reserved");
                        node.name = tokVal;
        ...
        function compile(code, options) {
            ...
            var url = options.url || '', sourceMaps = options.sourceMaps, paperFeatures1 = options.paperFeatures || {
            }, source = options.source || code, offset2 = options.offset || 0, agent = paper1.agent, version = agent.versionNumber, offsetCode = false, lineBreaks = /\r\n|\n|\r/mg, map;
            if (sourceMaps && (agent.chrome && version >= 30 || agent.webkit && version >= 537.76 || agent.firefox && version >= 23 || agent.node)) {
                if (agent.node) offset2 -= 2;
                else if (window && url && !window.location.href.indexOf(url)) {
                    var html = document.getElementsByTagName('html')[0].innerHTML;
                    offset2 = html.substr(0, html.indexOf(code) + 1).match(lineBreaks).length + 1;
                }
                offsetCode = offset2 > 0 && !(agent.chrome && version >= 36 || agent.safari && version >= 600 || agent.firefox && version >= 40 || agent.node);
                var mappings = [
                    'AA' + encodeVLQ(offsetCode ? 0 : offset2) + 'A'
                ];
                mappings.length = (code.match(lineBreaks) || []).length + 1 + (offsetCode ? offset2 : 0);
                map = {
                    version: 3,
                    file: url,
                    names: [],
            ...
            if (paperFeatures1.operatorOverloading !== false || paperFeatures1.moduleExports !== false) walkAST(parse(code, {
                ranges: true,
                preserveParens: true,
                sourceType: 'module'
            }), null, paperFeatures1);
            if (map) {
                if (offsetCode) code = new Array(offset2 + 1).join('\n') + code;
        ...
        function execute(code, scope1, options) {
            paper1 = scope1;
            var view = scope1.getView(), tool = /\btool\.\w+|\s+on(?:Key|Mouse)(?:Up|Down|Move|Drag)\b/.test(code) && !/\bnew\s+Tool\b/.test(code) ? new Tool() : null, toolHandlers = tool ? tool._events : [], handlers = [
                'onFrame',
                'onResize'
            ...
            var exports = Base1.each(handlers, function(key) {
            ...
            var exports = func && func.apply(scope1, args);
            var obj = exports || {
            };
            Base1.each(toolHandlers, function(key) {
                var value = obj[key];
        ...
        function loadScript(script) {
            if (/^text\/(?:x-|)paperscript$/.test(script.type) && PaperScope1.getAttribute(script, 'ignore') !== 'true') {
                var canvasId = PaperScope1.getAttribute(script, 'canvas'), canvas = document.getElementById(canvasId), src = script.src || script.getAttribute('data-src'), async = PaperScope1.hasAttribute(script, 'async'), scopeAttribute = 'data-paper-scope';
                if (!canvas) throw new Error('Unable to find canvas with id "' + canvasId + '"');
                var scope = PaperScope1.get(canvas.getAttribute(scopeAttribute)) || new PaperScope1().setup(canvas);
        ...
        function loadAll() {
            Base1.each(document && document.getElementsByTagName('script'), loadScript);
        }
    ...
    var paper1 = new (PaperScope1.inject(Base1.exports, {
        Base: Base1,
        Numerical: Numerical,
        Key: Key,
        DomEvent: DomEvent,
    ...
    if (paper1.agent.node) require('./node/extend.js')(paper1);
    if (typeof define === 'function' && define.amd) define('paper', paper1);
    else if (typeof module === 'object' && module) module.exports = paper1;
    return paper1;
}).call(this, typeof self === 'object' ? self : null);

},{"./node/self.js":"jhUEF","acorn":"h2wbx","./node/extend.js":"jhUEF"}],"jhUEF":[function(require,module,exports) {
"use strict";
...
},{}]},["kgrVz","3uymv"], "3uymv", "parcelRequireae9f")

//# sourceMappingURL=index.6b91fed9.js.map

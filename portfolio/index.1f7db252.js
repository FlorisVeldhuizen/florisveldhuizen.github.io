...
})({"8lBlw":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "69f74e7f31319ffd";
module.bundle.HMR_BUNDLE_ID = "70e502261f7db252";
"use strict";
...
},{}],"cdk4V":[function(require,module,exports) {
...
window.onload = ()=>{
    ...
    const checkKey = (e, keydown1)=>{
        if (e.keyCode == '38') upPressed = keydown1;
        if (e.keyCode == '40') downPressed = keydown1;
        if (e.keyCode == '37') leftPressed = keydown1;
        if (e.keyCode == '39') rightPressed = keydown1;
        setMovevector();
    };
...
},{"paper":"8952L","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"8952L":[function(require,module,exports) {
/*!
 ...
 *
 */ var paper1 = (function(self, undefined) {
        ...
        function inject(dest, src, enumerable, beans, preserve) {
            ...
            function field(name, val) {
                ...
                if (!preserve || !prev) {
                    ...
                    if (!res || isFunc || !res.get || typeof res.get !== 'function' || !Base2.isPlainObject(res)) res = {
                        value: res,
                        writable: true
                    };
            ...
            if (src) {
                ...
                for(var name in beansNames){
                    var part = beansNames[name], set1 = dest['set' + part], get = dest['get' + part] || set1 && dest['is' + part];
        ...
        statics: {
            ...
            serialize: function(obj, options, compact, dictionary) {
                ...
                if (isRoot) {
                    ...
                    dictionary = {
                        ...
                        add: function(item, create) {
                            ...
                            if (!ref) {
                                this.length++;
                                var res1 = create.call(item), name = item._class;
                                if (name && res1[0] !== name) res1.unshift(name);
                                this.definitions[id] = res1;
                ...
                if (obj && obj._serialize) {
                    ...
                    res = [];
                    for(var i = 0, l = obj.length; i < l; i++)res[i] = Base1.serialize(obj[i], options, compact, dictionary);
                    ...
                    for(var i = 0, l = keys.length; i < l; i++){
                        var key = keys[i];
                        res[key] = Base1.serialize(obj[key], options, compact, dictionary);
                    }
            ...
            deserialize: function(json, create, _data, _setDictionary, _isRoot) {
                var res2 = json, isFirst = !_data, hasDictionary = isFirst && json && json.length && json[0][0] === 'dictionary';
                _data = _data || {
                };
                if (Array.isArray(json)) {
                    ...
                    res2 = [];
                    for(var i = type ? 1 : 0, l = json.length; i < l; i++)res2.push(Base1.deserialize(json[i], create, _data, isDictionary, hasDictionary));
                    if (type) {
                        var args = res2;
                        if (create) res2 = create(type, args, isFirst || _isRoot);
                        else res2 = new type(args);
                    }
                } else if (Base1.isPlainObject(json)) {
                    res2 = {
                    };
                    if (_setDictionary) _data.dictionary = res2;
                    for(var key in json)res2[key] = Base1.deserialize(json[key], create, _data);
                }
                return hasDictionary ? res2[1] : res2;
            },
    ...
    var PaperScope = Base1.extend({
        _class: 'PaperScope',
        initialize: function PaperScope1() {
            paper2 = this;
            ...
            this.projects = [];
            this.tools = [];
            this._id = PaperScope1._id++;
            PaperScope1._scopes[this._id] = this;
            var proto = PaperScope1.prototype;
            if (!this.support) {
            ...
            if (!this.agent) {
                var user = self.navigator.userAgent.toLowerCase(), os = (/(darwin|win|mac|linux|freebsd|sunos)/.exec(user) || [])[0], platform = os === 'darwin' ? 'mac' : os, agent = proto.agent = proto.browser = {
                    platform: platform
                };
    ...
    var Point = Base1.extend({
        _class: 'Point',
        _readIndex: true,
        initialize: function Point1(arg0, arg1) {
    ...
    var LinkedPoint = Point.extend({
        initialize: function Point1(x, y, owner, setter) {
            this._x = x;
            this._y = y;
            this._owner = owner;
            this._setter = setter;
    ...
    var Size = Base1.extend({
        _class: 'Size',
        _readIndex: true,
        initialize: function Size1(arg0, arg1) {
            var type = typeof arg0, reading = this.__read, read = 0;
            if (type === 'number') {
    ...
    var LinkedSize = Size.extend({
        initialize: function Size1(width, height, owner, setter) {
            this._width = width;
            this._height = height;
            this._owner = owner;
            this._setter = setter;
    ...
    var Rectangle = Base1.extend({
        ...
        _readIndex: true,
        beans: true,
        initialize: function Rectangle1(arg0, arg1, arg2, arg3) {
        ...
        var x = parts[xFirst ? 0 : 1], y = parts[xFirst ? 1 : 0], getX = 'get' + x, getY = 'get' + y, setX = 'set' + x, setY = 'set' + y, get = 'get' + part, set2 = 'set' + part;
    ...
    var LinkedRectangle = Rectangle.extend({
        initialize: function Rectangle1(x, y, width, height, owner, setter) {
    ...
    var Matrix = Base1.extend({
        _class: 'Matrix',
        initialize: function Matrix1(arg, _dontNotify) {
            var args = arguments, count = args.length, ok = true;
            if (count >= 6) this._set.apply(this, args);
            else if (count === 1 || count === 2) {
                if (arg instanceof Matrix1) this._set(arg._a, arg._b, arg._c, arg._d, arg._tx, arg._ty, _dontNotify);
        ...
        invert: function() {
            var a = this._a, b = this._b, c = this._c, d = this._d, tx = this._tx, ty = this._ty, det = a * d - b * c, res2 = null;
        ...
        _inverseTransform: function(point, dest, _dontNotify) {
            ...
            if (det && !isNaN(det) && isFinite(tx) && isFinite(ty)) {
                ...
                if (!dest) dest = new Point();
                res2 = dest._set((x * d - y * c) / det, (y * a - x * b) / det, _dontNotify);
            }
            return res2;
        },
        decompose: function() {
    ...
    var Line = Base1.extend({
        _class: 'Line',
        initialize: function Line1(arg0, arg1, arg2, arg3, arg4) {
            var asVector = false;
    ...
    var Project = PaperScopeItem.extend({
        ...
        initialize: function Project1(element) {
            ...
            if (sets) {
                ...
                if (set2) {
                    for(var id in set2){
                        ...
                        for(var key in sets){
                            var other = sets[key];
                            if (other && other != set2) delete other[item._id];
                        }
                        item.remove();
                    }
                    sets[type] = null;
    ...
    var Item = Base1.extend(Emitter, {
        ...
        _initialize: function(props, point) {
            var hasProps = props && Base1.isPlainObject(props), internal = hasProps && props.internal === true, matrix = this._matrix = new Matrix(), project = hasProps && props.project || paper2.project, settings = paper2.settings;
        ...
        getBounds: function(matrix, options) {
            var hasMatrix = options || matrix instanceof Matrix, opts = Base1.set({
        ...
        _getCachedBounds: function(matrix, options, noInternal) {
            ...
            var res2 = this._getBounds(matrix || _matrix, options), rect = res2.rect || res2, style = this._style, nonscaling = res2.nonscaling || style.hasStroke() && !style.getStrokeScaling();
            if (cacheKey) {
        ...
        function hitTestChildren(point, options, viewMatrix, _exclude) {
            ...
            if (children) for(var i = children.length - 1; i >= 0; i--){
                ...
                var res2 = child !== _exclude && child._hitTest(point, options, viewMatrix);
                if (res2 && !options.all) return res2;
            }
            return null;
        }
        Project.inject({
        ...
        _hitTest: function(point, options, parentViewMatrix) {
            ...
            var checkSelf = !(options.guides && !this._guide || options.selected && !this.isSelected() || options.type && options.type !== Base1.hyphenate(this._class) || options.class && !(this instanceof options.class)), match = options.match, that = this, bounds, res3;
            function filter(hit) {
            ...
            if (checkSelf && this._parent && (checkPosition || checkCenter || checkBounds)) {
                ...
                res3 = checkPosition && checkPoint('position') || checkCenter && checkPoint('center', 'Center');
                if (!res3 && checkBounds) {
                    var points = [
                        'TopLeft',
                        'TopRight',
                    ...
                    for(var i = 0; i < 8 && !res3; i++)res3 = checkPoint('bounds', points[i]);
                }
                res3 = filter(res3);
            }
            if (!res3) res3 = this._hitTestChildren(point, options, viewMatrix) || checkSelf && filter(this._hitTestSelf(point, options, viewMatrix, this.getStrokeScaling() ? null : viewMatrix._shiftless().invert())) || null;
            if (res3 && res3.point) res3.point = matrix.transform(res3.point);
            return res3;
        },
        ...
        importJSON: function(json) {
            var res3 = Base1.importJSON(json, this);
            return res3 !== this ? this.addChild(res3) : res3;
        },
        addChild: function(item) {
            return this.insertChild(undefined, item);
        },
        insertChild: function(index, item) {
            var res3 = item ? this.insertChildren(index, [
                item
            ]) : null;
            return res3 && res3[0];
        },
        ...
        _insertAt: function(item, offset) {
            var owner = item && item._getOwner(), res3 = item !== this && owner ? this : null;
            if (res3) {
                res3._remove(false, true);
                owner._insertItem(item._index + offset, res3);
            }
            return res3;
        },
        ...
        _getOrder: function(item) {
            function getList(item1) {
                var list = [];
                do list.unshift(item1);
                while (item1 = item1._parent)
                return list;
            }
    ...
    var Group = Item.extend({
        ...
        initialize: function Group1(arg) {
            this._children = [];
            this._namedChildren = {
            };
    ...
    var Shape = Item.extend({
        ...
        initialize: function Shape1(props, point) {
        ...
        toPath: function(insert) {
            ...
            if (paper2.settings.applyMatrix) path.setApplyMatrix(true);
    ...
    var Raster = Item.extend({
        ...
        _smoothing: 'low',
        beans: true,
        initialize: function Raster1(source, position) {
        ...
        setImage: function(image) {
            ...
            function emit(event) {
                ...
                if (view && that.responds(type)) {
                    paper2 = view._scope;
                    that.emit(type, new Event1(event));
                }
            }
        ...
        setSource: function(src) {
            var image = new self.Image(), crossOrigin = this._crossOrigin;
    ...
    var SymbolItem = Item.extend({
        ...
        initialize: function SymbolItem1(arg0, arg1) {
        ...
        _hitTestSelf: function(point, options, viewMatrix) {
            ...
            var res3 = this._definition._item._hitTest(point, opts, viewMatrix);
            if (res3) res3.item = this;
            return res3;
        },
        _draw: function(ctx, param) {
    ...
    var SymbolDefinition = Base1.extend({
        ...
        initialize: function SymbolDefinition1(item, dontCenter) {
            this._id = UID.get();
    ...
    var HitResult = Base1.extend({
        _class: 'HitResult',
        initialize: function HitResult1(type, item, values) {
            this.type = type;
            this.item = item;
    ...
    var Segment = Base1.extend({
        ...
        beans: true,
        _selection: 0,
        initialize: function Segment1(arg0, arg1, arg2, arg3, arg4, arg5) {
    ...
    var SegmentPoint = Point.extend({
        initialize: function SegmentPoint1(point, owner, key) {
            var x, y, selected;
            if (!point) x = y = 0;
    ...
    var Curve = Base1.extend({
        _class: 'Curve',
        beans: true,
        initialize: function Curve1(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7) {
        ...
        divideAtTime: function(time, _setHandles) {
            var tMin = 0.00000001, tMax = 1 - tMin, res3 = null;
        ...
        statics: {
            ...
            solveCubic: function(v, coord, val, roots, min, max) {
                var v0 = v[coord], v1 = v[coord + 2], v2 = v[coord + 4], v3 = v[coord + 6], res3 = 0;
                if (!(v0 < val && v3 < val && v1 < val && v2 < val || v0 > val && v3 > val && v1 > val && v2 > val)) {
                    var c = 3 * (v1 - v0), b = 3 * (v2 - v1) - c, a = v3 - v0 - c - b;
                    res3 = Numerical.solveCubic(a, b, c, v0 - val, roots, min, max);
                }
                return res3;
            },
            ...
            _addBounds: function(v0, v1, v2, v3, coord, padding, min, max, roots) {
                function add(value, padding1) {
                    var left = value - padding1, right = value + padding1;
        ...
        function getIntersections(curves1, curves2, include, matrix1, matrix2, _returnFirst) {
            var epsilon = 0.0000001, self1 = !curves2;
    ...
    var CurveLocation = Base1.extend({
        ...
        initialize: function CurveLocation1(curve, time, point, _overlap, _distance) {
            if (time >= 0.99999999) {
        ...
        divide: function() {
            var curve = this.getCurve(), res3 = curve && curve.divideAtTime(this.getTime());
            if (res3) this._setSegment(res3._segment1);
            return res3;
        },
        split: function() {
            var curve = this.getCurve(), path = curve._path, res3 = curve && curve.splitAtTime(this.getTime());
            if (res3) this._setSegment(path.getLastSegment());
            return res3;
        },
        equals: function(loc, _ignoreOther) {
            var res3 = this === loc;
            if (!res3 && loc instanceof CurveLocation) {
                ...
                if (p1 === p2) {
                    ...
                    res3 = (diff < epsilon || p1 && abs(p1.getLength() - diff) < epsilon) && (!i1 && !i2 || i1 && i2 && i1.equals(i2, true));
                }
            }
            return res3;
        },
    ...
    var PathItem = Item.extend({
        ...
        getIntersections: function(path, include, _matrix, _returnFirst) {
            ...
            return self1 || this.getBounds(matrix1).intersects(path.getBounds(matrix2), 0.000000000001) ? Curve.getIntersections(this.getCurves(), !self1 && path.getCurves(), include, matrix1, matrix2, _returnFirst) : [];
        },
    ...
    var Path = PathItem.extend({
        ...
        _hitTestSelf: function(point, options, viewMatrix, strokeMatrix) {
            ...
            function checkSegmentStroke(segment) {
                ...
                if ((isJoin ? join : cap) === 'round') return isCloseEnough(segment._point, strokePadding);
                    ...
                    if (!area.isEmpty()) {
                        var loc1;
                        return area.contains(point) || (loc1 = area.getNearestLocation(point)) && isCloseEnough(loc1.getPoint(), tolerancePadding);
                    }
                }
            }
            if (options.ends && !options.segments && !closed) {
                if (res3 = checkSegmentPoints(segments[0], true) || checkSegmentPoints(segments[numSegments - 1], true)) return res3;
            } else if (options.segments || options.handles) {
                for(var i = 0; i < numSegments; i++)if (res3 = checkSegmentPoints(segments[i])) return res3;
            }
            if (strokeRadius !== null) {
        ...
        this[name + 'At'] = function(offset) {
            var loc2 = this.getLocationAt(offset);
            return loc2 && loc2[name]();
        };
    }, {
        beans: false,
        getLocationOf: function() {
            ...
            for(var i = 0, l = curves.length; i < l; i++){
                var loc2 = curves[i].getLocationOf(point);
                if (loc2) return loc2;
            }
            return null;
        },
        getOffsetOf: function() {
            var loc3 = this.getLocationOf.apply(this, arguments);
            return loc3 ? loc3.getOffset() : null;
        },
        ...
        statics: {
            ...
            getStrokeBounds: function(segments, closed, path, matrix, options) {
                ...
                function addJoin(segment, join1) {
                    if (join1 === 'round' || segment.isSmooth()) addRound(segment);
                    else Path._addBevelJoin(segment, join1, strokeRadius, miterLimit, matrix, strokeMatrix, addPoint);
                }
                function addCap(segment, cap1) {
                    if (cap1 === 'round') addRound(segment);
                    else Path._addSquareCap(segment, cap1, strokeRadius, matrix, strokeMatrix, addPoint);
                }
            ...
            _addSquareCap: function(segment, cap, radius, matrix, strokeMatrix, addPoint, isArea) {
                var point = segment._point.transform(matrix), loc3 = segment.getLocation(), normal = loc3.getNormal().multiply(loc3.getTime() === 0 ? radius : -radius).transform(strokeMatrix);
                if (cap === 'square') {
                    if (isArea) {
    ...
    var CompoundPath = PathItem.extend({
        ...
        beans: true,
        initialize: function CompoundPath1(arg) {
            this._children = [];
            this._namedChildren = {
            };
        ...
        this[key] = function(param) {
            var children = this._children, res3;
            for(var i = 0, l = children.length; i < l; i++)res3 = children[i][key](param) || res3;
            return res3;
        };
    }, {
    }));
    PathItem.inject(new function() {
        ...
        function preparePath(path, resolve) {
            var res3 = path.clone(false).reduce({
                simplify: true
            }).transform(null, true, true);
            if (resolve) {
                var paths = getPaths(res3);
                ...
                res3 = res3.resolveCrossings().reorient(res3.getFillRule() === 'nonzero', true);
            }
            return res3;
        }
        ...
        function traceBoolean(path1, path2, operation, options) {
            ...
            function collectPaths(paths3) {
                for(var i = 0, l = paths3.length; i < l; i++){
                    var path = paths3[i];
        ...
        function divideLocations(locations, include, clearLater) {
            ...
            for(var i = locations.length - 1; i >= 0; i--){
                var loc3 = locations[i], time = loc3._time, origTime = time, exclude = include && !include(loc3), curve = loc3._curve, segment;
                if (curve) {
                    if (curve !== prevCurve) {
                ...
                if (exclude) {
                    if (renormalizeLocs) renormalizeLocs.push(loc3);
                    continue;
                } else if (include) results.unshift(loc3);
                prevTime = origTime;
                ...
                loc3._setSegment(segment);
                var inter = segment._intersection, dest = loc3._intersection;
                if (inter) {
            ...
            function handleCurve(v) {
                ...
                if (po <= max(o0, o1, o2, o3) && po >= min(o0, o1, o2, o3)) {
                    var a0 = v[ia + 0], a1 = v[ia + 2], a2 = v[ia + 4], a3 = v[ia + 6], monoCurves = paL > max(a0, a1, a2, a3) || paR < min(a0, a1, a2, a3) ? [
                        v
                    ] : Curve.getMonoCurves(v, dir), res3;
                    for(var i = 0, l = monoCurves.length; i < l; i++){
                        if (res3 = addWinding(monoCurves[i])) return res3;
                    }
                }
            }
            for(var i = 0, l = curvesList.length; i < l; i++){
                var curve = curvesList[i], path = curve._path, v = curve.getValues(), res4;
                ...
                if (res4 = handleCurve(v)) return res4;
                if (i + 1 === l || curvesList[i + 1]._path !== path) {
                    if (vClose && (res4 = handleCurve(vClose))) return res4;
        ...
        function tracePaths(segments, operator) {
            ...
            function visitPath(path) {
                var segments1 = path._segments;
                for(var i = 0, l = segments1.length; i < l; i++)segments1[i]._visited = true;
            }
            function getCrossingSegments(segment, collectStarts) {
                ...
                function collect(inter1, end) {
                    while(inter1 && inter1 !== end){
                        var other = inter1._segment, path = other && other._path;
                        if (path) {
    ...
    var PathFlattener = Base1.extend({
        ...
        initialize: function(path, flatness, maxRecursion, ignoreStraight, matrix) {
            ...
            function addCurve(segment11, segment21) {
                var curve = Curve.getValues(segment11, segment21, matrix);
                curves.push(curve);
                computeParts(curve, segment11._index, 0, 1);
            }
    ...
    var TextItem = Item.extend({
        ...
        initialize: function TextItem1(arg) {
            this._content = '';
            this._lines = [];
    ...
    var PointText = TextItem.extend({
        _class: 'PointText',
        initialize: function PointText1() {
    ...
    var Color = Base1.extend(new function() {
        var types = {
            gray: [
                'gray'
            ],
        ...
        return Base1.each(types, function(properties, type) {
            ...
            _class: 'Color',
            _readIndex: true,
            initialize: function Color1(arg) {
            ...
            equals: function(color) {
                var col = Base1.isPlainValue(color, true) ? Color.read(arguments) : color;
    ...
    var Gradient = Base1.extend({
        _class: 'Gradient',
        initialize: function Gradient1(stops, radial) {
            this._id = UID.get();
    ...
    var GradientStop = Base1.extend({
        _class: 'GradientStop',
        initialize: function GradientStop1(arg0, arg1) {
    ...
    var Style = Base1.extend(new function() {
        var itemDefaults = {
            ...
            _class: 'Style',
            beans: true,
            initialize: function Style1(style, _owner, _project) {
                this._values = {
                };
                this._owner = _owner;
        ...
        Base1.each(groupDefaults, function(value, key) {
            var isColor = /Color$/.test(key), isPoint = key === 'shadowOffset', part = Base1.capitalize(key), flag = flags[key], set3 = 'set' + part, get = 'get' + part;
            fields[set3] = function(value1) {
                ...
                if (applyToChildren) for(var i = 0, l = children.length; i < l; i++)children[i]._style[set3](value1);
                if ((key === 'selectedColor' || !applyToChildren) && key in this._defaults) {
                    ...
                    if (old !== value1) {
                        if (isColor) {
                            ...
                            if (value1 && value1.constructor === Color) value1 = Color._setOwner(value1, owner, applyToChildren && set3);
                        }
            ...
            fields[get] = function(_dontMerge) {
                var owner = this._owner, children = owner && owner._children, applyToChildren = children && children.length > 0 && !(owner instanceof CompoundPath), value1;
                if (applyToChildren && !_dontMerge) for(var i = 0, l = children.length; i < l; i++){
                    var childValue = children[i]._style[get]();
                    if (!i) value1 = childValue;
                    else if (!Base1.equals(value1, childValue)) return undefined;
                }
                else if (key in this._defaults) {
                    var value1 = this._values[key];
                    if (value1 === undefined) {
                        value1 = this._defaults[key];
                        if (value1 && value1.clone) value1 = value1.clone();
                    } else {
                        var ctor = isColor ? Color : isPoint ? Point : null;
                        if (ctor && !(value1 && value1.constructor === ctor)) this._values[key] = value1 = ctor.read([
                            value1
                        ], 0, {
                            readNull: true,
                            clone: true
                ...
                if (value1 && isColor) value1 = Color._setOwner(value1, owner, applyToChildren && set3);
                return value1;
            };
            item[get] = function(_dontMerge) {
                return this._style[get](_dontMerge);
            };
            item[set3] = function(value1) {
                this._style[set3](value1);
            };
        });
        Base1.each({
            Font: 'FontFamily',
            ...
            var get = 'get' + key, set3 = 'set' + key;
            fields[get] = item[get] = '#get' + value;
            fields[set3] = item[set3] = '#set' + value;
        });
        Item.inject(item);
        return fields;
    }, {
    ...
    var DomElement = new function() {
        function handlePrefix(el, name, set3, value) {
            var prefixes = [
                '',
                'webkit',
                'moz',
    ...
    var View = Base1.extend(Emitter, {
        _class: 'View',
        initialize: function View1(project, element) {
            ...
            if (window && element) {
                ...
                if (this._id == null) element.setAttribute('id', this._id = 'paper-view-' + View1._id++);
            ...
            this._viewSize = size;
            View1._views.push(this);
            View1._viewsById[this._id] = this;
            (this._matrix = new Matrix())._owner = this;
            if (!View1._focused) View1._focused = this;
            this._frameItems = {
            };
        ...
        function emitMouseEvent(obj, target, type, event, point, prevPoint, stopItem) {
            ...
            function emit(obj1, type1) {
                if (obj1.responds(type1)) {
                    if (!mouseEvent) mouseEvent = new MouseEvent1(type1, event, point, target || obj1, prevPoint ? point.subtract(prevPoint) : null);
                    if (obj1.emit(type1, mouseEvent)) {
                        called = true;
                        if (mouseEvent.prevented) prevented = true;
                        if (mouseEvent.stopped) return stopped = true;
                    }
                } else {
                    var fallback = fallbacks[type1];
                    if (fallback) return emit(obj1, fallback);
                }
            }
        ...
        return {
            ...
            _handleMouseEvent: function(type, event, point) {
                ...
                function responds(type1) {
                    return itemEvents.virtual[type1] || view.responds(type1) || tool && tool.responds(type1);
                }
    ...
    var CanvasView = View.extend({
        _class: 'CanvasView',
        initialize: function CanvasView1(project, canvas) {
    ...
    var KeyEvent = Event1.extend({
        _class: 'KeyEvent',
        initialize: function KeyEvent1(type, event, key, character) {
            this.type = type;
            this.event = event;
            this.key = key;
    ...
    var ToolEvent = Event1.extend({
        _class: 'ToolEvent',
        _item: null,
        initialize: function ToolEvent1(tool, type, event) {
            this.tool = tool;
            this.type = type;
            this.event = event;
        },
    ...
    var Tool = PaperScopeItem.extend({
        ...
        initialize: function Tool1(props) {
        ...
        _handleMouseEvent: function(type, event, point, mouse) {
            ...
            function update(minDistance1, maxDistance1) {
                var pt = point, toolPoint = move ? tool._point : tool._downPoint || pt;
                if (move) {
                    if (tool._moveCount >= 0 && pt.equals(toolPoint)) return false;
                    if (toolPoint && (minDistance1 != null || maxDistance1 != null)) {
                        var vector = pt.subtract(toolPoint), distance = vector.getLength();
                        if (distance < (minDistance1 || 0)) return false;
                        if (maxDistance1) pt = toolPoint.add(vector.normalize(Math.min(distance, maxDistance1)));
                    }
                    tool._moveCount++;
                }
                tool._point = pt;
    ...
    var Tween = Base1.extend(Emitter, {
        _class: 'Tween',
        statics: {
            easings: new Base1({
                linear: function(t) {
        ...
        initialize: function Tween1(object, from, to, duration, easing, start) {
            this.object = object;
            var type = typeof easing;
            var isFunction = type === 'function';
            this.type = isFunction ? type : type === 'string' ? easing : 'linear';
            this.easing = isFunction ? easing : Tween1.easings[this.type];
    ...
    new function() {
        ...
        Project.inject({
            exportSVG: function(options) {
                options = setOptions(options);
                var children = this._children, view = this.getView(), bounds = Base1.pick(options.bounds, 'view'), mx = options.matrix || bounds === 'view' && view._matrix, matrix = mx && Matrix.read([
                    mx
    ...
    new function() {
        ...
        function getValue(node, name, isString, allowNull, allowPercent, defaultValue) {
            var value = SvgElement.get(node, name) || defaultValue, res5 = value == null ? allowNull ? null : isString ? '' : 0 : isString ? value : parseFloat(value);
            return /%\s*$/.test(value) ? res5 / 100 * (allowPercent ? 1 : rootSize[/x|^width/.test(name) ? 'width' : 'height']) : res5;
        }
        ...
        function getDefinition(value) {
            var match = value && value.match(/\((?:["'#]*)([^"')]+)/), name = match && match[1], res5 = name && definitions[window ? name.replace(window.location.href.split('#')[0] + '#', '') : name];
            if (res5 && res5._scaleToBounds) {
                res5 = res5.clone();
                res5._scaleToBounds = true;
            }
            return res5;
        }
        ...
        function importSVG(source, options, owner) {
            ...
            function onLoad(svg) {
                try {
                    ...
                    var onLoad1 = options.onLoad;
                    if (onLoad1) onLoad1(item, svg);
                } catch (e) {
                    onError(e);
                }
            }
            function onError(message, status) {
                var onError1 = options.onError;
                if (onError1) onError1(message, status);
                else throw new Error(message);
            }
    ...
    Base1.exports.PaperScript = (function() {
        ...
        if (!acorn) {
            ...
            (function(root, mod) {
                ...
                var getLineInfo = exports1.getLineInfo = function(input1, offset) {
                    for(var line = 1, cur = 0;;){
                        lineBreak.lastIndex = cur;
                        var match = lineBreak.exec(input1);
                ...
                exports1.tokenize = function(inpt, opts) {
                    input = String(inpt);
                    inputLen = input.length;
                    setOptions(opts);
                    initTokenState();
                ...
                function raise(pos, message) {
                    var loc4 = getLineInfo(input, pos);
                    message += " (" + loc4.line + ":" + loc4.column + ")";
                ...
                for(var kw in keywordTypes)exports1.tokTypes["_" + kw] = keywordTypes[kw];
                function makePredicate(words) {
                    ...
                    function compareTo(arr) {
                        ...
                        f += "switch(str){";
                        for(var i1 = 0; i1 < arr.length; ++i1)f += "case " + JSON.stringify(arr[i1]) + ":";
                ...
                var newline = /[\n\r\u2028\u2029]/;
                var lineBreak = /\r\n|[\n\r\u2028\u2029]/g;
                var isIdentifierStart = exports1.isIdentifierStart = function(code) {
                ...
                var isIdentifierChar = exports1.isIdentifierChar = function(code) {
                ...
                function parseBlock(allowStrict) {
                    var node = startNode(), first = true, strict1 = false, oldStrict;
                    node.body = [];
                    expect(_braceL);
                    while(!eat(_braceR)){
                        var stmt = parseStatement();
                        ...
                        if (first && allowStrict && isUseStrict(stmt)) {
                            oldStrict = strict1;
                            setStrict(strict1 = true);
                        }
                        first = false;
                    }
                    if (strict1 && !oldStrict) setStrict(false);
        ...
        function __$__(left, operator, right) {
            ...
            if (left && left[handler]) {
                var res5 = left[handler](right);
                return operator === '!=' ? !res5 : res5;
            }
            switch(operator){
                case '+':
                    return left + right;
        ...
        function compile(code, options) {
            ...
            function encodeVLQ(value) {
                var res6 = '', base64 = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/';
            ...
            var url = options.url || '', sourceMaps = options.sourceMaps, paperFeatures = options.paperFeatures || {
            }, source = options.source || code, offset = options.offset || 0, agent = paper2.agent, version = agent.versionNumber, offsetCode = false, lineBreaks = /\r\n|\n|\r/mg, map;
        ...
        function execute(code, scope, options) {
            ...
            code = compiled.code;
            function expose(scope1, hidden) {
                for(var key in scope1)if ((hidden || !/^_/.test(key)) && new RegExp('([\\b\\s\\W]|^)' + key.replace(/\$/g, '\\$') + '\\b').test(code)) {
                    params.push(key);
                    args.push(scope1[key]);
                }
            }
            expose({
                __$__: __$__,
    ...
    var paper2 = new (PaperScope.inject(Base1.exports, {
        Base: Base1,
        Numerical: Numerical,
        Key: Key,
        DomEvent: DomEvent,
    ...
    if (paper2.agent.node) require('./node/extend.js')(paper2);
    if (typeof define === 'function' && define.amd) define('paper', paper2);
    else if (typeof module === 'object' && module) module.exports = paper2;
    return paper2;
}).call(this, typeof self === 'object' ? self : null);

},{"./node/self.js":"8VSUO","acorn":"69xZY","./node/extend.js":"8VSUO"}],"8VSUO":[function(require,module,exports) {
"use strict";

},{}],"69xZY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
parcelHelpers.export(exports, "parse", ()=>parse2
);
parcelHelpers.export(exports, "parseExpressionAt", ()=>parseExpressionAt1
);
parcelHelpers.export(exports, "tokContexts", ()=>types$1
);
parcelHelpers.export(exports, "tokTypes", ()=>types
);
parcelHelpers.export(exports, "tokenizer", ()=>tokenizer1
);
...
pp$3.parseSubscript = function(base, startPos, startLoc, noCalls, maybeAsyncArrow) {
    ...
    if (computed || this.eat(types.dot)) {
        ...
        if (node$1.callee.type === "Import") {
            if (node$1.arguments.length !== 1) this.raise(node$1.start, "import() requires exactly one argument");
...
pp$3.parseExprAtom = function(refDestructuringErrors) {
    ...
    switch(this.type){
        ...
        case types._import:
            if (this.options.ecmaVersion > 10) return this.parseDynamicImport();
...
pp$3.parseDynamicImport = function() {
    var node = this.startNode();
    this.next();
    if (this.type !== types.parenL) this.unexpected();
...
pp$3.parseNew = function() {
    ...
    if (this.options.ecmaVersion > 10 && node.callee.type === "Import") this.raise(node.callee.start, "Cannot use new with import(...)");
...
},{}]},["8lBlw","cdk4V"], "cdk4V", "parcelRequireae9f")

//# sourceMappingURL=index.1f7db252.js.map

...
})({"irPah":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "69f74e7f31319ffd";
module.bundle.HMR_BUNDLE_ID = "c3c0e3b0959dd77f";
"use strict";
...
},{}],"f1eVp":[function(require,module,exports) {
...
function tick() {
    ...
    let code = _jsqrDefault.default(imageData.data, imageData.width, imageData.height, {
...
},{"jsqr":"5AUhc","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"5AUhc":[function(require,module,exports) {
    ...
    /******/ })([
        function(module, exports, __webpack_require__) {
            ...
            var BitMatrix = function() {
                function BitMatrix1(data, width) {
                    this.width = width;
                    this.height = data.length / width;
                    this.data = data;
                }
                BitMatrix1.createEmpty = function(width, height) {
                    return new BitMatrix1(new Uint8ClampedArray(width * height), width);
                };
                BitMatrix1.prototype.get = function(x, y) {
                    if (x < 0 || x >= this.width || y < 0 || y >= this.height) return false;
                    return !!this.data[y * this.width + x];
                };
                BitMatrix1.prototype.set = function(x, y, v) {
                    this.data[y * this.width + x] = v ? 1 : 0;
                };
                BitMatrix1.prototype.setRegion = function(left, top, width, height, v) {
        ...
        function(module, exports, __webpack_require__) {
            ...
            var GenericGF = function() {
                function GenericGF1(primitive, size, genBase) {
                ...
                GenericGF1.prototype.multiply = function(a, b) {
                    if (a === 0 || b === 0) return 0;
                    return this.expTable[(this.logTable[a] + this.logTable[b]) % (this.size - 1)];
                };
                GenericGF1.prototype.inverse = function(a) {
                    if (a === 0) throw new Error("Can't invert 0");
                    return this.expTable[this.size - this.logTable[a] - 1];
                };
                GenericGF1.prototype.buildMonomial = function(degree, coefficient) {
                ...
                GenericGF1.prototype.log = function(a) {
                    if (a === 0) throw new Error("Can't take log(0)");
                    return this.logTable[a];
                };
                GenericGF1.prototype.exp = function(a) {
        ...
        function(module, exports, __webpack_require__) {
            ...
            var GenericGFPoly = function() {
                function GenericGFPoly1(field, coefficients) {
                ...
                GenericGFPoly1.prototype.degree = function() {
                    return this.coefficients.length - 1;
                };
                GenericGFPoly1.prototype.isZero = function() {
                    return this.coefficients[0] === 0;
                };
                GenericGFPoly1.prototype.getCoefficient = function(degree) {
                    return this.coefficients[this.coefficients.length - 1 - degree];
                };
                GenericGFPoly1.prototype.addOrSubtract = function(other) {
                    var _a;
                    ...
                    return new GenericGFPoly1(this.field, sumDiff);
                };
                GenericGFPoly1.prototype.multiply = function(scalar) {
                    ...
                    return new GenericGFPoly1(this.field, product);
                };
                GenericGFPoly1.prototype.multiplyPoly = function(other) {
                ...
                GenericGFPoly1.prototype.multiplyByMonomial = function(degree, coefficient) {
                ...
                GenericGFPoly1.prototype.evaluateAt = function(a) {
                    var result = 0;
        ...
        function(module, exports, __webpack_require__) {
            ...
            var Matrix = function() {
                function Matrix1(width, height) {
                    this.width = width;
                    this.data = new Uint8ClampedArray(width * height);
                }
                Matrix1.prototype.get = function(x, y) {
                    return this.data[y * this.width + x];
                };
                Matrix1.prototype.set = function(x, y, value) {
        ...
        function(module, exports, __webpack_require__) {
            ...
            var Mode;
            (function(Mode1) {
                Mode1["Numeric"] = "numeric";
                Mode1["Alphanumeric"] = "alphanumeric";
                Mode1["Byte"] = "byte";
                Mode1["Kanji"] = "kanji";
                Mode1["ECI"] = "eci";
            ...
            var ModeByte;
            (function(ModeByte1) {
                ModeByte1[ModeByte1["Terminator"] = 0] = "Terminator";
                ModeByte1[ModeByte1["Numeric"] = 1] = "Numeric";
                ModeByte1[ModeByte1["Alphanumeric"] = 2] = "Alphanumeric";
                ModeByte1[ModeByte1["Byte"] = 4] = "Byte";
                ModeByte1[ModeByte1["Kanji"] = 8] = "Kanji";
                ModeByte1[ModeByte1["ECI"] = 7] = "ECI";
        ...
        function(module, exports, __webpack_require__) {
            ...
            var BitStream = function() {
                function BitStream1(bytes) {
                    this.byteOffset = 0;
                    this.bitOffset = 0;
                    this.bytes = bytes;
                }
                BitStream1.prototype.readBits = function(numBits) {
                ...
                BitStream1.prototype.available = function() {
        ...
        function(module, exports, __webpack_require__) {
            ...
            function locate(matrix) {
                ...
                .map(function(q) {
                    ...
                    var y1 = (q.top.y + q.bottom.y + 1) / 2;
                    if (!matrix.get(Math.round(x), Math.round(y1))) return;
                    var lengths = [
...
},{}]},["irPah","f1eVp"], "f1eVp", "parcelRequireae9f")

//# sourceMappingURL=index.959dd77f.js.map

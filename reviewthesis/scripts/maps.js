...
(function($){
    ...
    if (typeof(single_map) != 'undefined' && single_map != null) {
      ...
      //both lat and lng values start out unchanged
      let latCheck = false;
      let lngCheck = false;
      ...
      let callback = function(mutationsList, observer) {
        for(var mutation of mutationsList) {
          if (mutation.type == 'attributes') {
            if(mutation.attributeName === 'data-latitude'){
              latCheck = true;
            } else if (mutation.attributeName === 'data-longitude'){
              lngCheck = true;
            }
      ...
      if(single_map.getAttribute('data-latitude') == 0 && single_map.getAttribute('data-longitude') == 0){
        // Start observing the target node for configured mutations
        observer.observe(single_map, config);
      } else {
        checkDocMakeMap();
        observer.disconnect(); //stop observing
      }
